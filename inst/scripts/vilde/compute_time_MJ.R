...
n_cores <- c(16,32,8,1,4,12,2)
approach <- c("independence", "gaussian", "empirical","copula", "ctree")
...
fwrite(combos[i,], file = "inst/scripts/vilde/results_parallel_MJ.csv",append = TRUE)
}
