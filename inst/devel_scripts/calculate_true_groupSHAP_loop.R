...
results_copy[, Mean_group_MAE := mean(group_MAE), by = list(correlation, group1, group2)][] #list(beta_id, correlation, group1, group2)
results_copy[order(correlation)]
results_copy[,group_MAE := NULL]

View(unique(results_copy, by = "Mean_group_MAE"))
