...
saveRDS(results, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim3_nocat3",  sep = "/"))
...
results[, dim := dim]
results[, no_categories := no_categories]
saveRDS(results, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim3_nocat4",  sep = "/"))
...
saveRDS(timing2, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim3_nocat4",  sep = "/"))
...
results[, dim := dim]
results[, no_categories := no_categories]
saveRDS(results, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim4_nocat3",  sep = "/"))
...
saveRDS(timing2, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim4_nocat3",  sep = "/"))
...
saveRDS(results, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim5_nocat6",  sep = "/"))
...
saveRDS(timing2, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim5_nocat6",  sep = "/"))
...
saveRDS(results, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim7_nocat5",  sep = "/"))
...
saveRDS(results, file = paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim10_nocat4",  sep = "/"))
...
dim3_nocat3 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim3_nocat3", sep = "/"))
dim3_nocat4 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim3_nocat4", sep = "/"))
dim4_nocat3 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim4_nocat3", sep = "/"))
dim5_nocat6 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim5_nocat6", sep = "/"))
dim7_nocat5 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim7_nocat5", sep = "/"))
dim10_nocat4 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "results_dim10_nocat4", sep = "/"))
...
#colnames(t) <- c("dim", "number of categories", "method", "0", "0.1", "0.3", "0.5", "0.8", "0.9")
colnames(t)[1:9] <- c("method", "dim", "number of categories", "0", "0.1", "0.3", "0.5", "0.8", "0.9")
...
timing_dim3_nocat3 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim3_nocat3", sep = "/"))
timing_dim3_nocat4 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim3_nocat4", sep = "/"))
timing_dim4_nocat3 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim4_nocat3", sep = "/"))
timing_dim5_nocat6 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim5_nocat6", sep = "/"))
timing_dim7_nocat5 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim7_nocat5", sep = "/"))
timing_dim10_nocat4 <- readRDS(paste("/nr/project/stat/BigInsight/Projects/Fraud/Subprojects/NAV/Annabelle/results/paper_tables_new", "timing_dim10_nocat4", sep = "/"))
