...
for (k in 1:nrow(fileDT)){
    ...
    Shapley.approx$comb_Gaussian_sigma.01$other_objects$ll <- NULL
    Shapley.approx$comb_Gaussian_sigma.01$other_objects$DT[wcomb %in% 177:1024] <- Shapley.approx$Gaussian$other_objects$DT[wcomb %in% 177:1024]

    DT <- Shapley.approx$comb_Gaussian_sigma.01$other_objects$DT
    ...
    Shapley.approx$comb_Gaussian_sigma.01$Kshap <- Kshap
