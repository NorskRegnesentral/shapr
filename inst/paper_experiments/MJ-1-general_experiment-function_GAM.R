# This is the general function for experiment 3 for GAM2 and grouping B.
# This script of functions accompanies MJ-2-general_experiment-experiment2_GAM.R.
...
general_experiment = function(No_test_obs,
  ...
  print("Start group B for GAM now")
  # GROUP B---------------------------------------
  ...
  fwrite(tmp, file = "inst/paper_experiments/results/MJ-groupB_Shapley_values_GAM_diff_corr.csv", append = T)
  ...
  fwrite(tmp, file = "inst/paper_experiments/results/MJ-groupB-All_Shapley_values_GAM_diff_corr.csv", append = T)
