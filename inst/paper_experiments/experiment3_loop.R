...
for(corr in corr_vec){
  ...
  set.seed(seed)
  beta <- round(rnorm(28), 1)
  # -0.6  0.2 -0.8  1.6  0.3 -0.8  0.5  0.7  0.6 -0.3  1.5  0.4 -0.6 -2.2  1.1  0.0  0.0
  # [18]  0.9  0.8  0.6  0.9  0.8  0.1 -2.0  0.6 -0.1 -0.2 -1.5
  # pairwise between 1:6, 1:7, 1:8, 1:9, 1:10,
  #                  6:2, 6:3, 6:4, 6:5, 6:9, 6:10,
  #                  9:2, 9:3, 9:4, 9:5, 9:7, 9:8
  make_response1 = function(X, beta){
    ...
    return (
      beta[1] +
        ...
        beta[10] * feat_9_ +
        beta[11] * feat_10_ +
        beta[12] * (feat_1_ * feat_6_) +
        beta[13] * (feat_1_ * feat_7_) +
        beta[14] * (feat_1_ * feat_8_) +
        beta[15] * (feat_1_ * feat_9_) +
        beta[16] * (feat_1_ * feat_10_) +
        beta[17] * (feat_6_ * feat_2_) +
        beta[18] * (feat_6_ * feat_3_) +
        beta[19] * (feat_6_ * feat_4_) +
        beta[20] * (feat_6_ * feat_5_) +
        beta[21] * (feat_6_ * feat_9_) +
        beta[22] * (feat_6_ * feat_10_) +
        beta[23] * (feat_9_ * feat_2_) +
        beta[24] * (feat_9_ * feat_3_) +
        beta[25] * (feat_9_ * feat_4_) +
        beta[26] * (feat_9_ * feat_5_) +
        beta[27] * (feat_9_ * feat_7_) +
        beta[28] * (feat_9_ * feat_8_)
    )
  ...
  make_response2 = function(X, beta){
    ...
    return (
      beta[1] +
        ...
        beta[10] * feat_9_ +
        beta[11] * feat_10_ +
        beta[12] * (feat_1_ * feat_3_) +
        beta[13] * (feat_1_ * feat_4_) +
        beta[14] * (feat_1_ * feat_5_) +
        beta[15] * (feat_1_ * feat_6_) +
        beta[16] * (feat_1_ * feat_7_) +
        beta[17] * (feat_1_ * feat_8_) +
        beta[18] * (feat_1_ * feat_9_) +
        beta[19] * (feat_3_ * feat_2_) +
        beta[20] * (feat_3_ * feat_5_) +
        beta[21] * (feat_3_ * feat_6_) +
        beta[22] * (feat_3_ * feat_7_) +
        beta[23] * (feat_3_ * feat_8_) +
        beta[24] * (feat_3_ * feat_9_) +
        beta[25] * (feat_3_ * feat_10_) +
        beta[26] * (feat_5_ * feat_2_) +
        beta[27] * (feat_5_ * feat_4_) +
        beta[28] * (feat_5_ * feat_7_) +
        beta[29] * (feat_5_ * feat_8_) +
        beta[30] * (feat_5_ * feat_9_) +
        beta[31] * (feat_5_ * feat_10_) +
        beta[32] * (feat_7_ * feat_2_) +
        beta[33] * (feat_7_ * feat_4_) +
        beta[34] * (feat_7_ * feat_6_) +
        beta[35] * (feat_7_ * feat_9_) +
        beta[36] * (feat_7_ * feat_10_) +
        beta[37] * (feat_9_ * feat_2_) +
        beta[38] * (feat_9_ * feat_4_) +
        beta[39] * (feat_9_ * feat_6_) +
        beta[40] * (feat_9_ * feat_8_)
...
ggplot(data = results) + geom_point(aes(x = correlation, y = MDR, col = group))
