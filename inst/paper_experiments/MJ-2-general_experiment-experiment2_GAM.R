# This is to run experiment 3 for GAM2 and grouping B. Martin ran this for the paper. Took about 12 * 5 hours to finish.
...
source("inst/paper_experiments/MJ-1-general_experiment-function_GAM.R")
...
for(corr in corr_vector){
  general_experiment(No_test_obs = No_test_obs,
                     ...
                     model_name = "MJ-groupB-experiment_gam_diff_corr",
                     n_samples = n_samples)
}
