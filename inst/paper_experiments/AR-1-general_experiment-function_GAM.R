...
general_experiment = function(No_test_obs,
  ...
  print("Start group A for GAM now")
  # GROUP A---------------------------------------
  ...
  fwrite(tmp, file = "inst/paper_experiments/results/AR-groupA_Shapley_values_GAM_diff_corr.csv", append = T)
  ...
  fwrite(tmp, file = "inst/paper_experiments/results/AR-groupA-All_Shapley_values_GAM_diff_corr.csv", append = T)
