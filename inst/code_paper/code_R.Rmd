...
```
```{r fig-scatter_ctree, fig.width=7, fig.height=3}
...
```
```{r fig-waterfall_group, fig.width=7, fig.height=4}
...
```
```{r fig-beeswarm_caus_asym, echo=FALSE, message=FALSE, fig.width=14, fig.height=4, fig.scale=1.1}
library(ggplot2)
library(ggpubr)
