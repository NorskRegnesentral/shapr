...
data = data.table::fread("~/nr/project_stat/BI_PersonalisedMarketing/Explanations/Martin/groupShapley-paper/car_insurance_data/car_insurance_claim.csv")
...
saveRDS(explanation_group,"~/nr/project_stat/BI_PersonalisedMarketing/Explanations/Martin/groupShapley-paper/car_insurance_data/car_insurance_explanations.rds")
