...
## DNB data
trainData = read.table("M:/BigInsight/Projects/Explanations/Data/train6.csv",sep=";",header=TRUE)
## Remove response
...
sr = read.table("M:/BigInsight/Projects/Explanations/Kode/Shapley_Anders/all_results_experiment_Real_dim_28_Unknown_XGBoost_Unknown_newnames.csv",header=TRUE,sep=",")
...
## k=1,705,29
#k=1
folder <- "M:/BigInsight/Projects/Explanations/Doc/JMLR_V3-Kjersti/Fig/"
height <- 10
width <- 4.5
