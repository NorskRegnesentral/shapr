...
* Added practical guidance in README and general usage vignette for choosing conditional approaches, covering computational cost, $\operatorname{MSE}_{v}$, and recommendations from Olsen et al. (2024). (branch: docs/conditional-method-guidance)
