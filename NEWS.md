...
* Added practical guidance in README and general usage vignette for choosing conditional approaches, covering computational cost, $\operatorname{MSE}_{v}$, and recommendations from Olsen et al. (2024). ([#513](https://github.com/NorskRegnesentral/shapr/pull/513))
