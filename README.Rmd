...
For an overview of the methodology and capabilities of the package (as of v1.0.4), see the preprint of the
full length [software paper for `shapr` v1.0.4](https://arxiv.org/abs/2504.01842).
...
See @jullum2025shapr (preprint) for software paper with an overview of the methodology and capabilities of the 
