...
The most common task of machine learning is to train a model which is able to predict an unknown outcome (repsonse variable) based on a set of known input variables/features.
