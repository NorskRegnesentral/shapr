...
#> 
#> ── Starting `shapr::explain()` at 2026-06-23 20:14:41 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpTBLC8L/shapr_obj_1a5d2d409962.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-06-23 20:14:41
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
