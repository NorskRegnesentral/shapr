...
#> 
#> ── Starting `shapr::explain()` at 2026-01-07 20:21:39 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmppfCLKb/shapr_obj_24c72f2cbab7.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.5 seconds, started 2026-01-07 20:21:39
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
