...
#> 
#> ── Starting `shapr::explain()` at 2026-07-25 22:47:30 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpNULrP4/shapr_obj_620d69564106.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-07-25 22:47:30
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
