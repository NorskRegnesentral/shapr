...
#> 
#> ── Starting `shapr::explain()` at 2026-06-11 07:42:16 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpGKPk2Y/shapr_obj_22771d8ed021.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-06-11 07:42:16
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
