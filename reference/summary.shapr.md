...
#> 
#> ── Starting `shapr::explain()` at 2026-07-06 15:54:06 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpvaKfu3/shapr_obj_6243793f5749.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-07-06 15:54:06
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
