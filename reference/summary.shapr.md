...
#> 
#> ── Starting `shapr::explain()` at 2026-09-02 09:26:44 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmprSlhdE/shapr_obj_28661b826c18.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-09-02 09:26:44
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
