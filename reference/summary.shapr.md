...
#> 
#> ── Starting `shapr::explain()` at 2026-06-23 12:57:17 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpkHWaoC/shapr_obj_1b8e413f0fa4.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-06-23 12:57:17
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
