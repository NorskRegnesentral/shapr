...
#> 
#> ── Starting `shapr::explain()` at 2026-01-20 10:40:22 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpnNdRpd/shapr_obj_26cb38a300f5.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-01-20 10:40:22
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
