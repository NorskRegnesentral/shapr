...
#> 
#> ── Starting `shapr::explain()` at 2026-09-04 10:08:45 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpSunBY4/shapr_obj_1c10204c5331.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-09-04 10:08:45
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
