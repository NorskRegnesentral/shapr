...
#> 
#> ── Starting `shapr::explain()` at 2026-08-28 12:59:25 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmprFVzsv/shapr_obj_195b16e168ae.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.3 seconds, started 2026-08-28 12:59:25
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
