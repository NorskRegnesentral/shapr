...
#> 
#> ── Starting `shapr::explain()` at 2026-06-17 16:12:14 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/Rtmp9VfSyE/shapr_obj_1b7c59d72372.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-06-17 16:12:14
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
