...
#> 
#> ── Starting `shapr::explain()` at 2026-02-02 10:22:21 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpzohwYs/shapr_obj_27a5791159a1.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-02-02 10:22:21
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
