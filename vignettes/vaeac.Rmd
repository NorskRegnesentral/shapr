...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:08 ─────────────────
...
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16726424c3c.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:15 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16770a1f0ce.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:17 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167239e7592.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:21 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1674e77e85c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:26 ─────────────────
#> 
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpT1hWbC' at
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.03.25.725002_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.03.25.725002_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.03.25.725002_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:31 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1674c18fd31.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:41 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1674d64a275.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.056028        0.059795           9.9440             0.003880
#> Regular 0.091349        0.083601           9.2099             0.003351
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:03:53 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1677f1a868f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpT1hWbC' at
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.03.52.920419_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.03.52.920419_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.03.52.920419_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:04:00 ─────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch
...
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpT1hWbC' at
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.04.00.491651_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.04.00.491651_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.04.00.491651_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:05:30 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1675e369bad.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpT1hWbC' at
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.05.30.233223_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.05.30.233223_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.05.30.233223_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:06:16 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16736a9c26c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:06:40 ─────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpT1hWbC' at
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.06.40.187257_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.06.40.187257_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpT1hWbC/X2025.08.21.09.06.40.187257_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:06:46 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1671ad95d5f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1675bc73b0f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:07:38 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1673347bdac.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
