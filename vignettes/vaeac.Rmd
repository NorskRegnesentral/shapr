...
#> '/tmp/Rtmpj2jePl/shapr_obj_4be235b50aeda.rds'
#> 
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23187855a0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23283b3e98.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237cba3c62.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> Training the `vaeac` model with the
#> provided parameters from scratch on CPU.
#> Using 'specified_masks_mask_generator' with
#> '8' coalitions.
#> The vaeac model contains 17032 trainable
#> parameters.
#> Initializing vaeac model number 1 of 1.
#> Best vaeac inititalization was number 1 (of
#> 1) with a training VLB = -6.49 after 2
#> epochs. Continue to train this
#> inititalization.
#> 
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmpj2jePl' at
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.07.312753_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.07.312753_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.07.312753_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234b633358.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2329fa06a6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.057405         0.10396          10.3037            0.0034633
#> Regular 0.048447         0.17124           9.2183            0.0041277
```
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2372e582d6.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> provided parameters from scratch on CPU.
#> 
#> Using 'mcar_mask_generator' with
#> 'masking_ratio = 0.5'.
#> 
#> The vaeac model contains 17032 trainable
#> parameters.
...
#> 
#> Best vaeac inititalization was number 2 (of
#> 2) with a training VLB = -4.566 after 2
#> epochs. Continue to train this
#> inititalization.
#> 
#> 
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmpj2jePl' at
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.35.830481_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.35.830481_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.35.830481_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
[KBest vaeac inititalization was number 2 (of
#> 2) with a training VLB = -4.566 after 2
#> epochs. Continue to train this
#> inititalization.
#> ■■■■■■■■■■■■■■■■■■                57% | Tra…
...
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmpj2jePl' at
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.46.025159_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.46.025159_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.15.46.025159_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2315ab2c1c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> inititalization.
#> 
#> No IWAE improvment in 2 epochs. Apply early
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmpj2jePl' at
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.17.32.626905_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.17.32.626905_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.17.32.626905_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234e050dc9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> Initializing vaeac model number 2 of 2.
#> Best vaeac inititalization was number 2 (of
#> 2) with a training VLB = -4.814 after 2
#> epochs. Continue to train this
#> inititalization.
#> 
#> Results of the `vaeac` training process:
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmpj2jePl' at
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.18.49.709425_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.18.49.709425_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmpj2jePl/X2025.11.11.11.18.49.709425_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236638c099.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2353d696b.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231c5d87ea.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
