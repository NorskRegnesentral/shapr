...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:40 ────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854246053799.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:49 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854231a9ca6e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:53 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854226c7b4c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:58 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854245308bb1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:42:03 ────────────────────────────────────
#> 
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpTcbBFO' at
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.03.463152_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.03.463152_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.03.463152_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:42:11 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285427aa1ac1a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:42:23 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285427eaa8232.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.090089        0.045916           12.187            0.0042288
#> Regular 0.083661        0.046548           10.310            0.0044551
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:42:37 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285422f5ba791.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpTcbBFO' at
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.36.805866_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.36.805866_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.36.805866_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:42:47 ────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Initializing vaeac model number 1 of 2.
#>                                                                                            Initializing vaeac model number 2 of 2.
#> ■■■■■■■■■■                        29% | Training vaeac (init. 1 of 2): Epoch: 2 | VLB: -6…                                                                                           Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.566 after 2
#> epochs. Continue to train this inititalization.
#> ■■■■■■■■■■■■■■■■■■                57% | Training vaeac (init. 2 of 2): Epoch: 2 | VLB: -4…
#> Results of the `vaeac` training process:
#> Best epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> Best running avg epoch: 5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpTcbBFO' at
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.47.069767_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.47.069767_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.42.47.069767_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:44:52 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285424869ec83.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpTcbBFO' at
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.44.51.911794_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.44.51.911794_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.44.51.911794_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:45:58 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285423a9f6515.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:46:32 ────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpTcbBFO' at
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.46.32.036815_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.46.32.036815_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpTcbBFO/X2025.04.28.07.46.32.036815_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:46:39 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854277fb2218.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:46:40 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542187cc0d9.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:48:00 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285428418a7d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
