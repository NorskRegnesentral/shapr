...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:40 ──────────────────────────
...
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d42ff0550.rds'
#>
#>
#>
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:49 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d71dc8b88.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:53 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3ea41cf2.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:57 ──────────────────────────
#>
#> ── Explanation overview ──
#>
#> • Model class: <xgboost>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3da50e96d.rds'
#>
#> ── Main computation started ──
#>
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:38:02 ──────────────────────────
#>
...
#> Best vaeac inititalization was number 1 (of 1) with a training VLB = -6.49
#> after 2 epochs. Continue to train this inititalization.
#>
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpuzSVRD' at
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.01.784215_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.01.784215_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.01.784215_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:38:08 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d33499fef.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:38:19 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d650521cd.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.086984        0.043468           11.013            0.0047641
#> Regular 0.071817        0.040835           10.235            0.0048380
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:38:30 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d33bedd99.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.566
#> after 2 epochs. Continue to train this inititalization.
#>
#>
#> Results of the `vaeac` training process:
...
#>
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpuzSVRD' at
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.30.538541_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.30.538541_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.30.538541_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
#>
#> ℹ Coalitions split into 10 batches (mean 1.6 per batch).
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:38:40 ──────────────────────────
#>
#> ── Extra info about the pretrained vaeac model ──
#>
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpuzSVRD' at
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.40.135285_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.40.135285_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.38.40.135285_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:40:35 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d49b205ef.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpuzSVRD' at
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.40.35.485695_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.40.35.485695_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.40.35.485695_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
#>
#> ℹ Coalitions split into 10 batches (mean 1.6 per batch).
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:41:36 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d6607ef2.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:42:06 ──────────────────────────
#>
#> ── Extra info about the pretrained vaeac model ──
#>
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Initializing vaeac model number 1 of 2.
#> Initializing vaeac model number 2 of 2.
#> Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.814
#> after 2 epochs. Continue to train this inititalization.
#>
#> Results of the `vaeac` training process:
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/RtmpuzSVRD' at
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.42.06.562062_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.42.06.562062_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/RtmpuzSVRD/X2026.09.07.21.42.06.562062_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:42:13 ──────────────────────────
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d773eed68.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:42:15 ──────────────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d68ec8c07.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:43:29 ──────────────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d6de7b4bb.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
