...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:29:02 ───────────────────────────────────────────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c7cdc601e.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:29:36 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c3ec1124c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:30:04 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c7e2142d2.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:30:24 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c58dc140e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>     id_coalition coalitions coalitions_str coalition_size     N shapley_weight sample_freq features approach
#>            <int>     <list>         <char>          <int> <int>          <num>      <lgcl>   <list>   <char>
#>  1:            1                                        0     1       1.00e+06          NA              <NA>
#>  2:            2          1              1              1     4       2.50e-01          NA        1    vaeac
#>  3:            3          2              2              1     4       2.50e-01          NA        2    vaeac
#>  4:            4          3              3              1     4       2.50e-01          NA        3    vaeac
#>  5:            5          4              4              1     4       2.50e-01          NA        4    vaeac
#>  6:            6        1,2            1 2              2     6       1.25e-01          NA      1,2    vaeac
#>  7:            7        1,3            1 3              2     6       1.25e-01          NA      1,3    vaeac
#>  8:            8        1,4            1 4              2     6       1.25e-01          NA      1,4    vaeac
#>  9:            9        2,3            2 3              2     6       1.25e-01          NA      2,3    vaeac
#> 10:           10        2,4            2 4              2     6       1.25e-01          NA      2,4    vaeac
#> 11:           11        3,4            3 4              2     6       1.25e-01          NA      3,4    vaeac
#> 12:           12      1,2,3          1 2 3              3     4       2.50e-01          NA    1,2,3    vaeac
#> 13:           13      1,2,4          1 2 4              3     4       2.50e-01          NA    1,2,4    vaeac
#> 14:           14      1,3,4          1 3 4              3     4       2.50e-01          NA    1,3,4    vaeac
#> 15:           15      2,3,4          2 3 4              3     4       2.50e-01          NA    2,3,4    vaeac
#> 16:           16    1,2,3,4        1 2 3 4              4     1       1.00e+06          NA  1,2,3,4     <NA>
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:30:47 ───────────────────────────────────────────────────────────────────────────
#> 
...
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.30.47.12319_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.30.47.12319_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.30.47.12319_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:31:09 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c7bda2031.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:31:16 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c5bb137d5.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.070972        0.030595           6.5044            0.0047739
#> Regular 0.062654        0.027911           7.1153            0.0072951
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:32:34 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c7ee73d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.32.34.265811_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.32.34.265811_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.32.34.265811_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:32:59 ───────────────────────────────────────────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Initializing vaeac model number 1 of 2.
#>                                                                                                                         Initializing vaeac model number 2 of 2.
#> ■■■■■■■■■■                        29% | Training vaeac (init. 1 of 2): Epoch: 2 | VLB: -6.593 | IWAE: -3.321 | ETA:  3s                                                                                                                        Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.566 after 2 epochs. Continue to train this
#> inititalization.
#> ■■■■■■■■■■■■■■■■■■                57% | Training vaeac (init. 2 of 2): Epoch: 2 | VLB: -4.566 | IWAE: -3.226 | ETA:  2s
#> Results of the `vaeac` training process:
#> Best epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> Best running avg epoch: 5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.32.59.412574_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.32.59.412574_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.32.59.412574_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:35:17 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c59e64748.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.35.17.393665_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.35.17.393665_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.35.17.393665_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:36:35 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c6ae0f88.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:37:15 ───────────────────────────────────────────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.37.15.754276_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.37.15.754276_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo/X2025.08.05.13.37.15.754276_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:37:38 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c3b304ec4.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:37:39 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c4a7f3b16.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 13:38:24 ───────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\RtmpkhGKCo\shapr_obj_435c686b23d1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
