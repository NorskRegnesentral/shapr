...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:26:20 ───────────────────────────────────────────────────────
...
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520562b4008.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:26:44 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952085c520.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:27:06 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952012cbe9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:27:28 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952065f53717.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:27:52 ───────────────────────────────────────────────────────
#> 
...
#> Best vaeac inititalization was number 1 (of 1) with a training VLB = -6.49 after 2 epochs. Continue to train
#> this inititalization.
#> 
...
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.27.52.079235_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.27.52.079235_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.27.52.079235_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:28:16 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952062483505.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:28:23 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952034153e2.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.081431        0.177225           6.4285            0.0044789
#> Regular 0.057963        0.026802           7.1069            0.0097189
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:29:47 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95207bad714a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.29.47.13882_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.29.47.13882_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.29.47.13882_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:30:13 ───────────────────────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Initializing vaeac model number 1 of 2.
#>                                                                                                               Initializing vaeac model number 2 of 2.
#> ■■■■■■■■■■                        29% | Training vaeac (init. 1 of 2): Epoch: 2 | VLB: -6.593 | IWAE: -3.321…                                                                                                              Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.566 after 2 epochs. Continue to
#> train this inititalization.
#> ■■■■■■■■■■■■■■■■■■                57% | Training vaeac (init. 2 of 2): Epoch: 2 | VLB: -4.566 | IWAE: -3.226…
#> Results of the `vaeac` training process:
#> Best epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> Best running avg epoch: 5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.30.13.400075_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.30.13.400075_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.30.13.400075_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:32:42 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952057c626c0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.32.41.892241_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.32.41.892241_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.32.41.892241_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:34:03 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952064376712.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:34:48 ───────────────────────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Initializing vaeac model number 1 of 2.
#> Initializing vaeac model number 2 of 2.
#> Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.814 after 2 epochs. Continue to
#> train this inititalization.
#> 
#> Results of the `vaeac` training process:
...
#> ℹ The trained `vaeac` models are saved to folder 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7' at
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.34.47.697463_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.34.47.697463_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7/X2025.08.07.18.34.47.697463_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:35:12 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520410ecc5.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:35:13 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95203e0a2ae.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:36:02 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95202a5a15bf.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
