...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:26 ──────────────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02f4d69dd.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:35 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf020551428.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:38 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf03287883d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:42 ──────────────────────────────────────────────
#> 
#> ── Explanation overview ──
#> 
#> • Model class: <xgboost>
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf074704e43.rds'
#> 
#> ── Main computation started ──
#> 
...
#>     id_coalition coalitions coalitions_str coalition_size     N shapley_weight sample_freq features
#>            <int>     <list>         <char>          <int> <int>          <num>      <lgcl>   <list>
#>  1:            1                                        0     1       1.00e+06          NA         
#>  2:            2          1              1              1     4       2.50e-01          NA        1
#>  3:            3          2              2              1     4       2.50e-01          NA        2
#>  4:            4          3              3              1     4       2.50e-01          NA        3
#>  5:            5          4              4              1     4       2.50e-01          NA        4
#>  6:            6        1,2            1 2              2     6       1.25e-01          NA      1,2
#>  7:            7        1,3            1 3              2     6       1.25e-01          NA      1,3
#>  8:            8        1,4            1 4              2     6       1.25e-01          NA      1,4
#>  9:            9        2,3            2 3              2     6       1.25e-01          NA      2,3
#> 10:           10        2,4            2 4              2     6       1.25e-01          NA      2,4
#> 11:           11        3,4            3 4              2     6       1.25e-01          NA      3,4
#> 12:           12      1,2,3          1 2 3              3     4       2.50e-01          NA    1,2,3
#> 13:           13      1,2,4          1 2 4              3     4       2.50e-01          NA    1,2,4
#> 14:           14      1,3,4          1 3 4              3     4       2.50e-01          NA    1,3,4
#> 15:           15      2,3,4          2 3 4              3     4       2.50e-01          NA    2,3,4
#> 16:           16    1,2,3,4        1 2 3 4              4     1       1.00e+06          NA  1,2,3,4
#>     approach
#>       <char>
#>  1:     <NA>
#>  2:    vaeac
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:47 ──────────────────────────────────────────────
#> 
...
#> Best vaeac inititalization was number 1 (of 1) with a training VLB = -6.49 after 2 epochs. Continue
#> to train this inititalization.
#> 
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmp1oDRWT' at
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.36.47.480291_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.36.47.480291_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.36.47.480291_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:54 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf04c2894bc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:37:05 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02bb09bfa.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> Paired  0.073201        0.044632           11.358            0.0053456
#> Regular 0.073172        0.041246           10.963            0.0047514
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:37:17 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf076954664.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.566 after 2 epochs.
#> Continue to train this inititalization.
#> 
#> 
#> Results of the `vaeac` training process:
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmp1oDRWT' at
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.37.17.029364_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.37.17.029364_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.37.17.029364_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:37:25 ──────────────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Last epoch:             5. 	VLB = -3.318 	IWAE = -3.049 	IWAE_running = -3.149
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmp1oDRWT' at
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.37.25.435789_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.37.25.435789_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.37.25.435789_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:39:18 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0456e0d8a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmp1oDRWT' at
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.39.18.606042_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.39.18.606042_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.39.18.606042_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:40:18 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0ed75e23.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:40:48 ──────────────────────────────────────────────
#> 
#> ── Extra info about the pretrained vaeac model ──
#> 
#> Training the `vaeac` model with the provided parameters from scratch on CPU.
...
#> Initializing vaeac model number 1 of 2.
#> Initializing vaeac model number 2 of 2.
#> Best vaeac inititalization was number 2 (of 2) with a training VLB = -4.814 after 2 epochs.
#> Continue to train this inititalization.
#> 
#> Results of the `vaeac` training process:
...
#> ℹ The trained `vaeac` models are saved to folder '/tmp/Rtmp1oDRWT' at
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.40.48.118997_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.40.48.118997_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_best_running.pt'
#> '/tmp/Rtmp1oDRWT/X2026.06.03.16.40.48.118997_n_features_4_n_train_105_depth_3_width_32_latent_8_lr_0.001_epoch_last.pt'
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:40:56 ──────────────────────────────────────────────
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf034f4f7df.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:40:58 ──────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <ranger>
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf018bcd142.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:42:11 ──────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0601aa53f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
