...
[xx: Add some text here describing the summary and printing functionality, and how to extract results from the `explain()` output.
use the ex object above as an example. 
