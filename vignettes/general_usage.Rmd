...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:02 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
...
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1676ef65031.rds'
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:05 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16774b12138.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:11 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1676c05f54.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:12 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167e4c8ba2.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:13 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1671314a236.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Feature groups: S1: {"X1", "X2", "X3", "X4", "X5", "X6", "X7", "X8",
#> "X9", "X10"}; S2: {"X11", "X12", "X13", "X14", "X15", "X16", "X17",
#> "X18", "X19", "X20"}; S3: {"X21", "X22", "X23", "X24", "X25", "X26",
#> "X27", "X28", "X29", "X30"}; S4: {"X31", "X32", "X33", "X34", "X35",
#> "X36", "X37", "X38", "X39", "X40"}
#> 
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16717361378.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:18 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1673253594c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:19 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16776248c80.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:23 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16745fcf708.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167295d594f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:24 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16767f00602.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:32 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and
#>   is therefore set to `2^n_features = 32`.
#> 
#> 
#> ── Explanation overview ──
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16749ca702f.rds'
#> 
#> 
#> 
...
#> • Computed with`shapr::explain()` in 4.2 seconds, started 2025-08-21
#> 09:01:32
#> • Model class: <xgb.Booster>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:37 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and
#>   is therefore set to `2^n_features = 32`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1674d923856.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:44 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1673f27bdec.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167443a4f41.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:46 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1673a5edbc1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:47 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167224ee1c3.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:49 ─────────────────
#> ℹ You passed a model to `shapr::explain()` which is not natively
#>   supported, and did not supply a `get_model_specs` function to
#>   `shapr::explain()`.
#>   Consistency checks between model and data are therefore disabled.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <gbm>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167bbeea3d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:52 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167621a6894.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:01:55 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167602c1288.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:02:07 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167da85446.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:02:29 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167399790e7.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:02:34 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16732fc84c4.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:02:35 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and
#>   is therefore set to `2^n_features = 32`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d1674caa895f.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-21 09:02:36 ────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 4`, and
#>   is therefore set to `2^n_features = 4`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16710e4d8a0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-21 09:02:39 ────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 4`, and
#>   is therefore set to `2^n_features = 4`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d16728975abb.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-21 09:02:40 ────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and
#>   is therefore set to `2^n_features = 32`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpT1hWbC/shapr_obj_6d167657f07b8.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Summary of Shapley value explanation ───────────────────────────────
#> • Computed with`shapr::explain_forecast()` in 3.1 seconds, started
#> 2025-08-21 09:02:40
#> • Model class: <ar>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: empirical
