...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:35:36 ──────────────────────────
...
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d298a8888.rds'
#>
#>
#>
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:35:46 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3de0570c.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:35:57 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d44b3d84e.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:35:58 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d482cdcac.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:00 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4d9df81e.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:03 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d430cc0e.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:04 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_groups = 16`, and is
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5ad9e11e.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:06 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3afa043b.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:07 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d6dc02092.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:11 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d38b98251.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:12 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d788f0dd9.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d15733e6.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:17 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d17dc7636.rds'
#>
#>
#>
...
#>
#> ℹ Coalitions split into 2 batches (mean 4 per batch).
#>
#>
#>
#> ── Iteration 3 ─────────────────────────────────────────────────────────────────
...
#>
#> ℹ Coalitions split into 4 batches (mean 3 per batch).
#>
#>
#>
#> ── Iteration 4 ─────────────────────────────────────────────────────────────────
...
#>
#> ℹ Coalitions split into 2 batches (mean 7 per batch).
```
...
#> • Computed with `shapr::explain()` in 4.1 seconds, started 2026-09-07 21:36:17
#> • Model class: <xgboost>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Iterative
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:22 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is
#>   therefore set to `2^n_features = 32`.
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d211a889e.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:26 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is
#>   therefore set to `2^n_features = 32`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d43ee6d7f.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:29 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d11251a7e.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:30 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d7ee53b10.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:32 ──────────────────────────
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3c6ef6.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:34 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d11263fa0.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:37 ──────────────────────────
#> ℹ You passed a model to `shapr::explain()` which is not natively supported, and
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d184541f7.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:42 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d337ca7ad.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:36:45 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d292b1dfa.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:02 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5aafa0.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:22 ──────────────────────────
#>
#> ── Explanation overview ──
#>
#> • Model class: <xgboost>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4788da3d.rds'
#>
#> ── Iterative computation started ──
#>
#> ── Iteration 1 ─────────────────────────────────────────────────────────────────
...
#> ℹ Coalitions split into 6 batches (mean 3 per batch).
#>
#> ── Iteration 5 ─────────────────────────────────────────────────────────────────
#> ℹ Using 20 of 32 coalitions, 2 new.
#> ℹ Coalitions split into 2 batches (mean 10 per batch).
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:28 ──────────────────────────
#>
#> ── Explanation overview ──
#>
#> • Model class: <xgboost>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4cc7916a.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 24 of 32 coalitions.
#> ℹ Coalitions split into 4 batches (mean 6 per batch).
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:37:29 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is
#>   therefore set to `2^n_features = 32`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d607b9493.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ℹ Coalitions split into 2 batches (mean 13 per batch).
```
...
#>
#> ── Starting `shapr::explain_forecast()` at 2026-09-07 21:37:31 ─────────────────
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d6c63fa99.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain_forecast()` at 2026-09-07 21:37:34 ─────────────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 4`, and is
#>   therefore set to `2^n_features = 4`.
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5d0f7b11.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain_forecast()` at 2026-09-07 21:37:35 ─────────────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is
#>   therefore set to `2^n_features = 32`.
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d22a89525.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Summary of Shapley value explanation ────────────────────────────────────────
#> • Computed with `shapr::explain_forecast()` in 3.9 seconds, started 2026-09-07
#> 21:37:35
#> • Model class: <ar>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: empirical
