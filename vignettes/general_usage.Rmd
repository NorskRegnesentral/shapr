...
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`,
...
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`,
#>   and is therefore set to `2^n_features = 32`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
