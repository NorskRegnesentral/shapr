...
To compute SAGE values, set `sage = TRUE` and provide the response vector `y_explain` corresponding to the rows of
`x_explain`. The loss function is controlled through `sage_args$loss_func`; if not supplied, `shapr` uses logistic
