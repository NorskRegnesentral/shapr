...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:01 ────────────────────────────────────
...
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285427c712830.rds'
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:05 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854238ea9158.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:13 ────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285421bedcaa7.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:14 ────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854238d520ac.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:15 ────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854235f72a24.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:16 ────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 16`, and is therefore set
#>   to `2^n_groups = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542446468eb.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:18 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285424b0b6895.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:19 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285425b4c6256.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:22 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285421566b0b0.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285426e2f48d8.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:23 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285423d00914e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:26 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542256e6fe9.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:29 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore
#>   set to `2^n_features = 32`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542314712d6.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:33 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285424634dcd.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:34 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542cb7c0f8.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:36 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 4`, and is therefore set
#>   to `2^n_groups = 4`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854241dad1ce.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:37 ────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542292bcc2e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:40 ────────────────────────────────────
#> ℹ You passed a model to `shapr::explain()` which is not natively supported, and did not
#>   supply a `get_model_specs` function to `shapr::explain()`.
#>   Consistency checks between model and data is therefore disabled.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <gbm>
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285422c92d267.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:44 ────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285425a25693b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:40:47 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285421469a827.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:03 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285425b8aaff.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:26 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285426af21696.rds'
#> 
#> 
#> 
#> ── iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:30 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285424721aba9.rds'
#> 
#> ── Main computation started ──
#> 
...
#> [1] "/tmp/RtmpTcbBFO/shapr_obj_285424721aba9.rds"
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 07:41:31 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore
#>   set to `2^n_features = 32`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542412b2487.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-04-28 07:41:33 ───────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 4`, and is therefore set
#>   to `2^n_features = 4`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542ac4f3dd.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-04-28 07:41:35 ───────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 4`, and is therefore set
#>   to `2^n_features = 4`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542214bbd8f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-04-28 07:41:36 ───────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore
#>   set to `2^n_features = 32`.
...
#> • Number of observations to explain: 1
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542654d7780.rds'
#> 
#> 
#> 
#> ── Main computation started ──
