...
# dependence using
# the empirical (conditional) distribution approach with bandwidth parameter sigma =
# 0.1 (default)
explanation <- explain(
  model = model,
  x_explain = x_explain,
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:09 ───────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444ec5cce1.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 15:01:11 ─────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is therefore set to `2^n_features = 32`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpIOXT2V/shapr_obj_329d9f124d9c52.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> Error:
#> ! future_lapply() interrupted at 2026-06-03T15:01:11, while running on 'jullum-ubuntu' (pid 3317151) [future <unnamed>; on c15d09dd8cc1be516aa6437d6b5be856@jullum-ubuntu<3317151> at 2026-06-03 15:01:11.283769]
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:17 ───────────────────────────────
#> 
#> ── Explanation overview ──
#> 
#> • Model class: <xgboost>
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4441169dbd.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:22 ───────────────────────────────
#> 
#> ── Explanation overview ──
#> 
#> • Model class: <xgboost>
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44693dfbed.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:23 ───────────────────────────────
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441acdf1b2.rds'
#> 
#> 
#> 
#> ── Main computation started ──
