...
#> 
#> ── Starting `shapr::explain()` at 2025-11-11
#> ℹ Feature classes extracted from the model
#>   contain `NA`.
#>   Assuming feature classes from the data
#>   are correct.ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
#> • v(S) estimation class: Monte Carlo
#> integration
#> • Approach: empirical
...
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231fe161ab.rds'
#> 
...
#>   Assuming feature classes from the data
#>   are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2370353d78.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2372075b6c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2328230ccb.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233f1aa70e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> ── Starting `shapr::explain()` at 2025-11-11
#> ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_groups = 16`, and is therefore
...
#> 
#> • Feature groups: S1: {"X1", "X2", "X3",
#> "X4", "X5", "X6", "X7", "X8", "X9", "X10"};
#> S2: {"X11", "X12", "X13", "X14", "X15",
#> "X16", "X17", "X18", "X19", "X20"}; S3:
#> {"X21", "X22", "X23", "X24", "X25", "X26",
#> "X27", "X28", "X29", "X30"}; S4: {"X31",
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23468fd577.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231ee0783e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234c94e960.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232444ef1f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233d1bdaa4.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • v(S) estimation class: Monte Carlo
#> integration
#> • Approach: gaussian, empirical, and
#> independence
#> • Procedure: Non-iterative
#> • Number of Monte Carlo integration
#> samples: 100
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2351faaac1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236ea4c00.rds'
#> 
#> 
#> 
...
#> • Computed with `shapr::explain()` in 4.5
#> seconds, started 2025-11-11 10:56:52
#> • Model class: <xgb.Booster>
#> • v(S) estimation class: Monte Carlo
#> integration
#> • Approach: gaussian
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Number of coalitions used: 18 (of total
#> 32)
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236ea4c00.rds'
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23d7cab24.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237244ade1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23b7d888a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>   are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_groups = 4`, and is therefore
#>   set to `2^n_groups = 4`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Feature groups: A: {"Temp", "Month"}; B:
#> {"Wind", "Solar.R"}
#> 
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23581271eb.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232a0d1cac.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-11-11
#> ℹ You passed a model to `shapr::explain()`
#>   which is not natively supported, and did
#>   not supply a `get_model_specs` function
#>   to `shapr::explain()`.
#>   Consistency checks between model and data
#>   are therefore disabled.ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2369b15f53.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2352483cbc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23787b3ed.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237904fe9f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237964f7a7.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23fc2e8f8.rds'
#> 
#> ── Main computation started ──
#> 
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23acb1864.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2
#> ℹ Feature names extracted from the model
#>   contain `NA`.
#>   Consistency checks between model and data
#>   are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_features = 4`, and is therefore
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2379ee92f1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23107899d9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237094a79f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> in 3.3 seconds, started 2025-11-11 11:14:16
#> • Model class: <ar>
#> • v(S) estimation class: Monte Carlo
#> integration
#> • Approach: empirical
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 1
#> • Number of coalitions used: 32 (of total
#> 32)
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237094a79f.rds'
#> 
