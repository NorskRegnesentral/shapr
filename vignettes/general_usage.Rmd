...
| `summary.shapr`    | Prints a formatted summary of the Shapley value computation,
                       and returns the output of `get_results()`                                                 |
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:07 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc63fa720e.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:11 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc435a394f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:18 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc49363c3a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:21 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc270f43be.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:22 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfce4498e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:23 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 16`, and is therefore set to `2^n_groups = 16`.
#> 
#> 
#> ── Explanation overview ──
#> 
...
#> 
#> • Feature groups: S1: "X1", "X2", "X3", "X4", "X5", "X6", "X7", "X8", "X9", "X10"; S2: "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20";
#> S3: "X21", "X22", "X23", "X24", "X25", "X26", "X27", "X28", "X29", "X30"; S4: "X31", "X32", "X33", "X34", "X35", "X36", "X37", "X38", "X39", "X40"
#> 
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc2722e9b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:25 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc79386169.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:26 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
#> • Approach: empirical
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc5dd4ac8.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:29 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc19c0760f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc256c6aa6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc753043.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:42 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features = 32`.
#> 
#> 
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc549e6a4.rds'
#> 
#> 
#> 
...
The `summary(explain_object)` function provides a neatly formatted summary of the object and (invisibly) returns a
complete list of summary components.
...
#> 1:          1 43.09   1.258  6.486 -21.89 -6.464 -1.2702
#> 2:          2 43.09  -3.717  2.282 -14.30 -4.416 -0.9483
#> 3:          3 43.09  -1.159 -8.892 -12.86 -3.866 -0.1902
#> 4:          4 43.09   4.163 -6.220 -16.94 -3.478 -5.1878
#> 5:          5 43.09   3.090  1.764 -24.73 -6.004 -4.6952
#> 6:          6 43.09  -2.602 -5.148 -12.49 -3.672 -1.9491
print(ex, what = "shapley_sd") # Prints the estimated standard deviations of the Shapley values
#>    explain_id      none Solar.R  Wind    Temp Month    Day
#>         <int>     <num>   <num> <num>   <num> <num>  <num>
#> 1:          1 3.060e-07  0.5386 2.072 0.05372 2.033 0.2709
#> 2:          2 3.016e-07  0.7698 1.355 0.23023 1.284 0.4309
#> 3:          3 4.259e-07  0.8536 1.367 0.33087 1.228 0.4934
#> 4:          4 6.733e-07  1.3104 2.295 0.72485 1.931 0.3940
#> 5:          5 5.208e-07  1.0750 1.743 0.63426 1.694 0.7498
#> 6:          6 5.414e-07  1.2962 1.590 0.61541 1.432 0.5686
...
#> • Computed with`shapr::explain()` at 2025-08-05 10:29:42
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Procedure: Iterative
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc549e6a4.rds'
#> • Total number of coalitions used: 18 (of 32)
#> 
#> ── Convergence info
...
#> 
#> ── Estimated Shapley values (sd in parantheses)
#>             none       Solar.R          Wind           Temp         Month           Day
#>           <char>        <char>        <char>         <char>        <char>        <char>
#> 1: 43.086 (0.00)  1.258 (0.54)  6.486 (2.07) -21.888 (0.05) -6.464 (2.03) -1.270 (0.27)
#> 2: 43.086 (0.00) -3.717 (0.77)  2.282 (1.36) -14.300 (0.23) -4.416 (1.28) -0.948 (0.43)
#> 3: 43.086 (0.00) -1.159 (0.85) -8.892 (1.37) -12.857 (0.33) -3.866 (1.23) -0.190 (0.49)
#> 4: 43.086 (0.00)  4.163 (1.31) -6.220 (2.29) -16.939 (0.72) -3.478 (1.93) -5.188 (0.39)
#> 5: 43.086 (0.00)  3.090 (1.08)  1.764 (1.74) -24.729 (0.63) -6.004 (1.69) -4.695 (0.75)
#> 6: 43.086 (0.00) -2.602 (1.30) -5.148 (1.59) -12.492 (0.62) -3.672 (1.43) -1.949 (0.57)
#> 
#> 
#> ── Estimated MSEv 
#> 
#> ℹ The estimated MSE of v(S) = 252.29 (with sd = 76.26)
...
#>    explain_id       none Solar.R   Wind    Temp  Month     Day
#>         <int>      <num>   <num>  <num>   <num>  <num>   <num>
#> 1:          1 3.0598e-07 0.53861 2.0722 0.05372 2.0327 0.27087
#> 2:          2 3.0162e-07 0.76982 1.3551 0.23023 1.2844 0.43089
#> 3:          3 4.2586e-07 0.85360 1.3669 0.33087 1.2281 0.49341
#> 4:          4 6.7326e-07 1.31039 2.2946 0.72485 1.9312 0.39398
#> 5:          5 5.2081e-07 1.07501 1.7426 0.63426 1.6942 0.74981
#> 6:          6 5.4142e-07 1.29621 1.5901 0.61541 1.4318 0.56859
summary_ex$timing$total_time_secs # Total computation time in seconds
#> [1] 4.3475
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:49 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features = 32`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc62832c90.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:51 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc5f5c5f8b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:53 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc4a877859.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:54 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 4`, and is therefore set to `2^n_groups = 4`.
#> 
#> 
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc15863c36.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:55 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc27ec7c1a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:29:58 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ You passed a model to `shapr::explain()` which is not natively supported, and did not supply a `get_model_specs` function to `shapr::explain()`.
#>   Consistency checks between model and data is therefore disabled.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <gbm>
#> • Approach: empirical
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc63801a32.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:30:03 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc39a35cd2.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:30:06 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc745358b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:30:35 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features = 16`.
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc7c4321a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:31:06 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc568479a6.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:31:10 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc295c7d96.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-05 10:31:11 ─────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features = 32`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfcac569d5.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-05 10:31:13 ────────────────────────────────────────────────────────────────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc771e46b1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-05 10:31:17 ────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 4`, and is therefore set to `2^n_features = 4`.
#> 
...
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc208850d4.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>          <num>   <num> <num>  <num>  <num>
#> 1:      153.00    1.00 77.79 -6.578 -0.134
#> 2:      153.00    2.00 77.79 -5.980 -0.288
```
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-05 10:31:19 ────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features = 32`.
#> 
...
#> • Number of observations to explain: 1
#> 
#> • Computations (temporary) saved at: 'C:\Users\jullum\AppData\Local\Temp\Rtmp6nFgDw\shapr_obj_bdfc1cd42819.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 1:      151.00    1.00 77.96 -0.6779 -0.6734 -1.269 0.49341      NA
#> 2:      151.00    2.00 77.96  0.3997 -0.5006 -1.465 0.06591 -0.4742

summary(explanation_forecast)
#> 
#> ── Summary of Shapley value explanation ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> • Computed with`shapr::explain_forecast()` at 2025-08-05 10:31:19
#> • Model class: <ar>
#> • Approach: empirical
#> • Procedure: Non-iterative
#> • Number of feature-wise Shapley values: 5
...
#>      none Temp.1 Temp.2 Wind.1 Wind.F1 Wind.F2
#>    <char> <char> <char> <char>  <char>  <char>
#> 1:  77.96 -0.678 -0.673 -1.269   0.493      NA
#> 2:  77.96  0.400 -0.501 -1.465   0.066  -0.474
#> ── Estimated MSEv 
#> ℹ The estimated MSE of v(S) = NULL (with sd = NULL)
```
