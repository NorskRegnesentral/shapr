...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:37 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf041e04fb9.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:42 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf079f9902a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:53 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf018097183.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:54 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02d8bd0da.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:56 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf074da4388.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:56 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_groups = 16`, and is therefore set to
#>   `2^n_groups = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Feature groups: S1: {"X1", "X2", "X3", "X4", "X5", "X6", "X7", "X8", "X9", "X10"}; S2: {"X11",
#> "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20"}; S3: {"X21", "X22", "X23", "X24",
#> "X25", "X26", "X27", "X28", "X29", "X30"}; S4: {"X31", "X32", "X33", "X34", "X35", "X36", "X37",
#> "X38", "X39", "X40"}
#> 
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf049d46a66.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:58 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0646e9ac9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:34:59 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf043b07a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:03 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf074a4dc29.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:04 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0308168a6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf043f8b32e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:08 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is therefore set to
#>   `2^n_features = 32`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf07b993c39.rds'
#> 
#> 
#> 
...
#> • Computed with `shapr::explain()` in 3.7 seconds, started 2026-06-03 16:35:08
#> • Model class: <xgboost>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Iterative
...
#> 1:          1 43.09 (0)  1.43 (1.39)  4.75 (2.70) -20.31 (0.72) -5.46 (2.74) 0.71 (0.86)
#> 2:          2 43.09 (0) -3.52 (0.80) -1.31 (1.22) -16.77 (0.55) -5.50 (1.20) 1.99 (0.60)
#> 3:          3 43.09 (0) -1.17 (1.28) -7.83 (1.29) -11.19 (0.79) -4.78 (1.01) 2.22 (0.78)
#> 4:          4 43.09 (0)  9.53 (3.75) -7.07 (2.96) -16.64 (1.08) -4.46 (1.79) 0.25 (1.35)
#> 5:          5 43.09 (0)  8.43 (2.31) -1.03 (1.90) -22.15 (0.62) -4.83 (1.63) 0.99 (0.72)
#> 6:          6 43.09 (0) -2.66 (1.02) -7.17 (0.96) -12.44 (0.65) -5.18 (0.75) 0.81 (0.61)
#> 
#> 
#> ── Estimated MSEv 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:13 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is therefore set to
#>   `2^n_features = 32`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02c409182.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:16 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf055fa3f82.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:18 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02fb651f0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:19 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_groups = 4`, and is therefore set to `2^n_groups
#>   = 4`.
#> 
#> 
#> ── Explanation overview ──
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02ffa026a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:20 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf073f2b599.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:24 ──────────────────────────────────────────────
...
#>   Consistency checks between model and data are therefore disabled.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <gbm>
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf053d3e449.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:28 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf06d39f31.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:32 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02f70fd60.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:35:49 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf022a31b37.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:11 ──────────────────────────────────────────────
#> 
#> ── Explanation overview ──
#> 
#> • Model class: <xgboost>
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf03136fca9.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:16 ──────────────────────────────────────────────
#> 
#> ── Explanation overview ──
#> 
#> • Model class: <xgboost>
...
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf012327415.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:36:17 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is therefore set to
#>   `2^n_features = 32`.
#> 
#> 
...
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf052796deb.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2026-06-03 16:36:18 ─────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0255370b5.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2026-06-03 16:36:21 ─────────────────────────────────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 4`, and is therefore set to
#>   `2^n_features = 4`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf065d57e09.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2026-06-03 16:36:22 ─────────────────────────────────────
#> ℹ Feature names extracted from the model contain `NA`.
#>   Consistency checks between model and data are therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 32`, and is therefore set to
#>   `2^n_features = 32`.
...
#> • Number of observations to explain: 1
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf03a338e62.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Summary of Shapley value explanation ────────────────────────────────────────────────────────────
#> • Computed with `shapr::explain_forecast()` in 3.7 seconds, started 2026-06-03 16:36:22
#> • Model class: <ar>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: empirical
#> • Procedure: Non-iterative
