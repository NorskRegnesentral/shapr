...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:25 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_8640708b59e3.rds'
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:32 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864018a45c8.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:47 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86401dcb68a4.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:52 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86402ed6594e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:53 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864033064f7a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:55 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 16`, and is therefore set to `2^n_groups =
#>   16`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Feature groups: S1: {"X1", "X2", "X3", "X4", "X5", "X6", "X7", "X8", "X9", "X10"}; S2: {"X11", "X12",
#> "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20"}; S3: {"X21", "X22", "X23", "X24", "X25", "X26",
#> "X27", "X28", "X29", "X30"}; S4: {"X31", "X32", "X33", "X34", "X35", "X36", "X37", "X38", "X39", "X40"}
#> 
#> • Number of observations to explain: 6
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864027f55db.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:48:59 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864033511400.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:01 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_8640480018c5.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:06 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_8640535d350.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:07 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864060f41980.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:08 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86406da66140.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:25 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features
#>   = 32`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86407462b63.rds'
#> 
#> 
#> 
...
#> • Computed with`shapr::explain()` at 2025-08-07 22:49:25
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Procedure: Iterative
#> • Number of feature-wise Shapley values: 5
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:38 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features
#>   = 32`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86401bcd4ab1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:41 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864057837329.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:45 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864036581a4c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:47 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864015ee76a9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:50 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86405e9665c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:49:54 ───────────────────────────────────────────────────────
#> ℹ You passed a model to `shapr::explain()` which is not natively supported, and did not supply a
#>   `get_model_specs` function to `shapr::explain()`.
#>   Consistency checks between model and data is therefore disabled.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
#> • Model class: <gbm>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86406b1d7701.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:50:03 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864042203bea.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:50:09 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86403bad5c79.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:50:53 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_8640788a35bd.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:51:45 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86401ddc729.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:51:55 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_8640b465954.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 22:51:57 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features
#>   = 32`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864050ab340f.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-07 22:52:00 ──────────────────────────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 4`, and is therefore set to `2^n_features =
#>   4`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86402af15d4.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-07 22:52:07 ──────────────────────────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 4`, and is therefore set to `2^n_features =
#>   4`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_86402e3549a7.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain_forecast()` at 2025-08-07 22:52:09 ──────────────────────────────────────────────
#> ℹ Feature names extracted from the model contains `NA`.
#>   Consistency checks between model and data is therefore disabled.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 32`, and is therefore set to `2^n_features
#>   = 32`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpKavXBX\shapr_obj_864026b11d82.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Summary of Shapley value explanation ─────────────────────────────────────────────────────────────────────
#> • Computed with`shapr::explain_forecast()` at 2025-08-07 22:52:09
#> • Model class: <ar>
#> • Approach: empirical
#> • Procedure: Non-iterative
#> • Number of feature-wise Shapley values: 5
