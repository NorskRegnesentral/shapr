...
```
#> Error in knitr::include_graphics("figure_asymmetric_causal/Asymmetric_ordering.webp"): Cannot find the file(s): "figure_asymmetric_causal/Asymmetric_ordering.webp"
```
...
```
#> Error in knitr::include_graphics("figure_asymmetric_causal/Causal_ordering.webp"): Cannot find the file(s): "figure_asymmetric_causal/Causal_ordering.webp"
```
...
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 128`,
#>   and is therefore set to `2^n_features = 128`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than the number of
#>   coalitions respecting the causal ordering (20), and is therefore
#>   set to 20.
#> ── Explanation overview ──
#> 
...
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_groups = 64`, and
#>   is therefore set to `2^n_groups = 64`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
