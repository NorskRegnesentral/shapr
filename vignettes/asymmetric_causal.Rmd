...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:01:35 ────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854222432ebd.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:01:42 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854273f9ba78.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:14 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285422b1ac0aa.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#> gaussian 1123200   80740        6.80
#> ctree    1087698   70158       31.66
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:23 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542182675c2.rds'
#> 
#> 
#> 
#> ── iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:28 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 20, and is therefore set to 20.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> • Number of asymmetric coalitions: 20
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854250be8380.rds'
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:30 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 20, and is therefore set to 20.
#> ── Explanation overview ──
...
#> • Number of asymmetric coalitions: 20
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854269a5bc7.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:38 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 20, and is therefore set to 20.
#> ── Explanation overview ──
...
#> • Number of asymmetric coalitions: 20
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285421d95fb1f.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#>                          MSEv MSEv_sd Time (secs)
#> gaussian               318652   36279        5.22
#> gaussian_non_iterative 306458   35412        1.34
#> ctree                  260332   29391        8.60
#> xgboost                307562   39363        1.74
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:42 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854227ed0d56.rds'
#> 
#> 
#> 
#> ── iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:02:49 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
#> ── Explanation overview ──
...
#> • Causal ordering: {trend, cosyear, sinyear, temp, atemp, windspeed, hum}
#> • Components with confounding: {trend, cosyear, sinyear, temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854224ad5574.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:03:05 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285421704642.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#>                      MSEv MSEv_sd Time (secs)
#> gaussian          1380661  111239        6.78
#> independence_marg 1379855  110801       15.54
#> independence_con  1379646  110728        7.35
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:03:13 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854211631f18.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:03:47 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
#> ── Explanation overview ──
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854266d404fd.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#>             MSEv MSEv_sd Time (secs)
#> gaussian 1112304   85462       33.58
#> copula   1162757   90975       17.51
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:04:05 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 20, and is therefore set to 20.
...
#> • Components with confounding: {cosyear, sinyear}
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542615c23cf.rds'
#> 
#> 
#> 
#> ── iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:04:10 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 20, and is therefore set to 20.
#> ── Explanation overview ──
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285421ea50a61.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:04:15 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 20, and is therefore set to 20.
#> ── Explanation overview ──
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285425fb053f7.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 20 of 20 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:11:55 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> 
#> 
...
#> • Components with confounding: {cosyear, sinyear}
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285427cf042f3.rds'
#> 
#> 
#> 
#> ── iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:12:06 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ── Explanation overview ──
#> 
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285427ed66999.rds'
#> 
#> ── Main computation started ──
#> 
...
#>   1: 0.00 (0.00) -2181.91 (389.03)  -825.541 (377.21) -240.377 (257.68)  -34.336 ( 63.89)
#>   2: 0.00 (0.00) -2174.36 (384.98)  -846.615 (381.99) -187.047 (273.99)  -41.247 ( 54.60)
#>   3: 0.00 (0.00) -2088.96 (373.84)  -793.628 (365.63) -187.854 (248.84)  -94.019 ( 50.84)
#>   4: 0.00 (0.00) -2103.36 (379.95)  -798.135 (377.31) -109.116 (270.58)  191.341 (105.19)
#>   5: 0.00 (0.00) -2003.88 (362.92)  -723.936 (346.66) -234.815 (228.12)   42.276 ( 43.88)
#>  ---                                                                                     
#> 140: 0.00 (0.00)  1575.95 (631.53) -1014.078 (569.93)  248.468 (371.16)  -41.158 (210.29)
#> 141: 0.00 (0.00)  1588.69 (650.49) -1057.223 (573.59)   33.389 (242.37)   11.209 ( 34.71)
#> 142: 0.00 (0.00)  1466.74 (635.17) -1109.151 (558.07)  -97.322 (243.07)  -35.612 ( 69.65)
#> 143: 0.00 (0.00)  1003.94 (665.91) -1780.473 (623.77) -104.818 (347.18)   20.563 ( 64.24)
#> 144: 0.00 (0.00)   711.14 (787.04) -2635.898 (784.97) -184.269 (536.88)   47.650 (137.29)
#>                  atemp          windspeed                hum
#>                 <char>             <char>             <char>
#>   1:    0.212 ( 55.92)   116.765 ( 70.18)    13.809 ( 88.83)
#>   2:   34.980 ( 23.07)    13.847 ( 36.81)   181.122 ( 77.88)
#>   3:  -17.900 ( 43.43)   244.641 ( 61.81)  -132.542 ( 59.19)
#>   4:   44.353 ( 61.89)  -183.831 ( 66.85)  -228.803 (108.61)
#>   5:    4.164 ( 31.93)   203.339 ( 47.27)   -32.184 ( 55.58)
#>  ---                                                        
#> 140:   16.011 (195.60)   361.816 (171.47)   589.554 (262.98)
#> 141:    6.738 ( 23.45)   216.482 ( 30.02)   -80.279 ( 48.53)
#> 142:  129.072 ( 27.12)    79.352 ( 39.85)   265.536 ( 93.28)
#> 143:   -4.875 ( 28.60)    47.647 ( 34.25)  -233.045 ( 82.77)
#> 144:  -66.930 ( 74.15)  -469.796 ( 83.42)   558.271 (204.47)
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:12:10 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 64`, and is therefore set
#>   to `2^n_groups = 64`.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854219696a29.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:12:18 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 64`, and is therefore set
#>   to `2^n_groups = 64`.
#> ── Explanation overview ──
#> 
#> • Model class: <xgb.Booster>
...
#> • Number of group-wise Shapley values: 6
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285423c4b82d6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 64 of 64 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:12:22 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp_group, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_28542ddedeb0.rds'
#> 
#> ── Main computation started ──
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:12:23 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_groups = 64`, and is therefore set
#>   to `2^n_groups = 64`.
#> ── Explanation overview ──
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp_group, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_285423c0fb268.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 64 of 64 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-04-28 08:12:38 ────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or number of coalitions respecting the
#>   causal ordering 12, and is therefore set to 12.
#> ── Explanation overview ──
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp_group, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpTcbBFO/shapr_obj_2854215d2e6a1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 12 of 12 coalitions.
...
#> [1,]             8.0233                3.7587                0.89044           14.369
#>      asymmetric_causal
#> [1,]             1.537
```
