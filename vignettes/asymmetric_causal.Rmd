...
library(GGally)
library(ggpubr)
#> Error in library(package, pos = pos, lib.loc = lib.loc, character.only = TRUE, : there is no package called 'ggpubr'
library(gridExtra)
#> Error in library(package, pos = pos, lib.loc = lib.loc, character.only = TRUE, : there is no package called 'gridExtra'
...
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237ce9142c.rds'
#> 
#> 
#> 
...
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233e29b04c.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232aa087cc.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#> gaussian 1076528   75021        9.82
#> ctree    1044396   66196       59.68
#> xgboost  1086792   62794       21.98
```
...
#>   are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger
#>   than the number of coalitions respecting
#>   the causal ordering (20), and is
#>   therefore set to 20.
#> 
#> 
#> ── Explanation overview ──
...
#> 
#> • Causal ordering: {trend}, {cosyear,
#> sinyear}, {temp, atemp, windspeed, hum}
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231ebea250.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236f1f4122.rds'
#> 
...
#> sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2342ae2f88.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#> sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234e9cd246.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#>                          MSEv MSEv_sd Time (secs)
#> gaussian               306849   35460        3.39
#> gaussian_non_iterative 306458   35412        1.80
#> ctree                  270172   31527       12.51
#> xgboost                304617   35310        4.04
...
#> sinyear, temp, atemp, windspeed, hum}
#> 
#> • Components with confounding: {trend,
#> cosyear, sinyear, temp, atemp, windspeed,
#> hum}
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2343ed5aa4.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> hum}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2353fd0e9e.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23629ca5c3.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#>                      MSEv MSEv_sd Time (secs)
#> gaussian          1376367  109262       10.96
#> independence_marg 1377106  108898        9.78
#> independence_con  1376651  108870       10.88
...
#> sinyear}, {temp, atemp, windspeed, hum}
#> 
#> • Components with confounding: {cosyear,
#> sinyear}
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23be1e867.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> sinyear}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23210ffe46.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#>             MSEv MSEv_sd Time (secs)
#> gaussian 1112304   85462       28.01
#> copula   1131125   87179       22.04
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231312cbad.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> sinyear}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23512774be.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ─────────────────────────────
...
#> sinyear}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234bfb5b29.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 20 of 20 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23305b278.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> sinyear}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233c0e2866.rds'
#> 
#> ── Main computation started ──
#> 
...
plot_SV_several_approaches(explanation_n_coal, index_x_explain) +
  theme(legend.position = "bottom", print_ggplot = FALSE) +
  guides(fill = guide_legend(nrow = 2))
```

![](figure_asymmetric_causal/n_coalitions_plot_SV-1.webp)![](figure_asymmetric_causal/n_coalitions_plot_SV-2.webp)
...
#>   are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger
#>   than `2^n_groups = 64`, and is therefore
...
#> 
#> • Feature groups: trend: {"trend"};
#> cosyear: {"cosyear"}; sinyear: {"sinyear"};
#> temp_group: {"temp", "atemp"}; windspeed:
#> {"windspeed"}; hum: {"hum"}
#> 
#> • Number of observations to explain: 144
#> 
...
#> 
#> • Components with confounding: {trend,
#> cosyear, sinyear, temp_group, windspeed,
#> hum}
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231d785af3.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23267ca19c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 64 of 64 coalitions.
...
#> sinyear}, {temp_group, windspeed, hum}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232a0af189.rds'
#> 
#> ── Main computation started ──
#> 
...
#> sinyear}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2347961324.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 64 of 64 coalitions.
...
#> sinyear}
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be235a3298d9.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 12 of 12 coalitions.
