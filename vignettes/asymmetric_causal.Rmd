...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2157eb884.rds'
#> 
#> 
#> 
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb266162d71.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteratio
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2a6f119e.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteratio
...
#> gaussian 1101051   71271       11.50
#> ctree    1060934   63108       87.57
#> xgboost  1090931   58988       17.38
```
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb268567061.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb270722f9d.rds'
#> 
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2297cf425.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteratio
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb22f7e5fac.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteratio
...
#>                          MSEv MSEv_sd Time (secs)
#> gaussian               339662   38586        3.56
#> gaussian_non_iterative 339521   38588        1.67
#> ctree                  282686   32264       17.35
#> xgboost                321763   39778        3.58
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:31:40 ───────────────────────────────
...
#> hum}
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af445196c229.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:31:54 ───────────────────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
...
#> • Components with confounding: {trend, cosyear, sinyear, temp, atemp, windspeed,
#> hum}
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af443103f269.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:32:04 ───────────────────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 128`, and is therefore
#>   set to `2^n_features = 128`.
...
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4436018b9e.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────
...
#>                      MSEv MSEv_sd Time (secs)
#> gaussian          1396525  109151       12.10
#> independence_marg 1390794  107977        9.22
#> independence_con  1390287  107899       14.45
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb21c8f2c5c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2ab29a8b.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteratio
...
#>             MSEv MSEv_sd Time (secs)
#> gaussian 1147280   83432       31.76
#> copula   1166326   86145       26.44
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb21be0012.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2766dcd0e.rds'
#> 
#> ── Iterative computation started ──
#> 
#> ── Iteratio
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb27b9ad00e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 20 of 20 coalitions.
...
# Get explicands with similar temperature: 2012-10-09 (October) and 2012-12-03
# (December)
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb259af7f7e.rds'
#> 
#> 
#> 
#> ── Iterative computation started ──
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb27fe69466.rds'
#> 
#> ── Main computation started ──
#> 
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb247ba8758.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2527ee7a3.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 64 of 64 coalitions.
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb26088e225.rds'
#> 
#> ── Main computation started ──
#> 
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb266d9b137.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 64 of 64 coalitions.
...
#> (temporary)
#> saved at:
#> '/tmp/RtmpRxBWws/shapr_obj_32adb2482240d9.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 12 of 12 coalitions.
