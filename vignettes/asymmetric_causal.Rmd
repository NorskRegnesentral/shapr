...
Monte Carlo-based approaches (`independence` (not recommended), `empirical`, `gaussian`, `copula`, `ctree`, `vaeac`,
`categorical` and `arf`), while the extension of the asymmetric
