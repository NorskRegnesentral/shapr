...
This vignette elaborates and illustrates the regression
paradigm explained in @olsen2023comparative. We describe
...
models. We refer to @olsen2023comparative for when one should
use the different paradigms, method classes, and methods.

@olsen2023comparative divides the regression paradigm into
...
with default hyperparameters. In thelast section, we include all Monte
...
#>                      MSEv Time
#> MC_empirical       179.43 1.37
#> sep_lm             745.21 0.81
#> sep_pcr            784.91 0.82
#> sep_splines        165.13 0.71
#> sep_reicpe_example 687.45 1.35
```
...
#> sep_tree_stump     218.05  0.87
#> sep_tree_default   177.68  0.64
#> sep_tree_cv        169.96 14.69
#> sep_tree_cv_2      166.17 26.97
#> sep_rf             210.99  1.93
#> sep_rf_cv          212.88 31.15
```
...
#> sep_xgboost_cv       164.69 15.41
#> sep_xgboost_cv_par   164.69 11.00
#> sep_xgboost_cv_2_par 146.51 10.72
```
...
in @olsen2023comparative for more details and examples.
...
#> sep_xgboost_cv_2_par 146.51 10.72
#> sur_lm               649.61  0.30
#> sur_xgboost          169.92  0.23
#> sur_xgboost_cv       169.87  1.69
#> sur_rf               195.10  0.41
#> sur_rf_cv            171.84 23.94
#> sur_rf_cv_par        171.84 17.16
...
#> sur_rf_cv_par        171.84 17.16
#> sep_ppr              327.23  0.67
#> sep_ppr_cv           269.74  9.18
#> sur_ppr              395.42  0.22
#> sur_ppr_cv           415.62  1.37
...
print_MSEv_scores_and_time(explanation_list)
#>                        MSEv  Time
#> MC_independence      206.92  0.29
#> MC_empirical         179.43  1.37
#> MC_gaussian          245.19  0.43
#> MC_copula            247.29  0.34
#> MC_ctree             191.82  1.42
#> MC_vaeac             141.88 48.50
#> sep_lm               745.21  0.81
#> sep_pcr              784.91  0.82
#> sep_splines          165.13  0.71
#> sep_reicpe_example   687.45  1.35
...
#>                   MSEv  Time
#> MC_independence 641.82  0.34
#> MC_ctree        554.50  1.53
#> MC_vaeac        629.43 98.87
#> sep_lm          550.06  0.70
#> sep_splines     541.36  0.80
#> sep_tree        753.84  0.63
#> sep_tree_cv     756.27 27.40
#> sep_rf          521.79  1.01
#> sep_rf_cv       609.58 36.98
#> sep_xgboost     792.17  0.74
#> sep_xgboost_cv  595.98 16.35
#> sur_lm          610.61  0.27
#> sur_splines     596.86  0.27
#> sur_tree        677.04  0.21
#> sur_tree_cv     789.37  2.08
#> sur_rf          414.15  0.41
#> sur_rf_cv       533.06 11.89
#> sur_xgboost     606.92  0.65
#> sur_xgboost_cv  429.06  2.09
...
#> sep_lm      745.21  0.70
#> sep_pcr     784.91  0.77
#> sep_splines 165.13  0.77
#> sep_tree_cv 169.96 12.62
#> sep_rf_cv   212.88 27.36
#> sur_rf_cv   171.84 23.80
