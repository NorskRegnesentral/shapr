...
#>                      MSEv Time
#> MC_empirical       179.43 1.64
#> sep_lm             745.21 0.97
#> sep_pcr            784.91 1.72
#> sep_splines        165.13 2.07
#> sep_reicpe_example 687.45 1.78
```
...
#> sep_splines        165.13 2.07
#> sep_reicpe_example 687.45 1.78
#> sep_tree_stump     218.05 1.23
#> sep_tree_default   177.68 1.05
```
...
#> sep_tree_stump     218.05  1.23
#> sep_tree_default   177.68  1.05
#> sep_tree_cv        169.96 22.91
#> sep_tree_cv_2      168.38 45.74
#> sep_rf             210.99  1.47
#> sep_rf_cv          206.03 36.68
```
...
#> sep_rf               210.99  1.47
#> sep_rf_cv            206.03 36.68
#> sep_xgboost          197.72  1.16
#> sep_xgboost_cv       175.05 11.31
#> sep_xgboost_cv_par   175.05  9.65
#> sep_xgboost_cv_2_par 129.11 11.50
```
...
#> sur_lm               649.61  0.27
#> sur_rf               195.10  0.60
#> sur_rf_cv            173.74 20.21
#> sur_xgboost          169.92  0.31
#> sur_xgboost_cv       169.87  2.44
...
```r
# Additional libraries needed to create new parsnip model 
library(tibble)
library(rlang)
#> 
...
#> sur_xgboost_cv       169.87  2.44
#> sep_ppr              327.23  1.12
#> sep_ppr_cv           249.87 26.65
#> sur_ppr              395.42  0.30
#> sur_ppr_cv           334.61  3.67
...
print_MSEv_scores_and_time(explanation_list)
#>                        MSEv  Time
#> MC_independence      206.92  0.47
#> MC_empirical         179.43  1.77
#> MC_gaussian          245.19  0.40
#> MC_copula            247.29  0.41
#> MC_ctree             191.82  1.98
#> MC_vaeac             141.88 75.13
#> sep_lm               745.21  0.97
#> sep_pcr              784.91  1.72
#> sep_splines          165.13  2.07
#> sep_reicpe_example   687.45  1.78
...
explanation_list_mixed$sur_rf_cv <- explain(
  ...
  regression_tune_values = expand_grid(mtry = c(1, 2, 4), trees = c(50, 250, 500, 750)),
  regression_vfold_cv_para = list(v = 5)
)
...
#>                   MSEv   Time
#> MC_independence 641.82   0.64
#> MC_ctree        554.50   2.58
#> MC_vaeac_50     629.43 158.67
#> sep_lm          550.06   1.33
#> sep_splines     541.36   1.29
#> sep_tree        753.84   1.02
#> sep_tree_cv     756.27  40.66
#> sep_rf          521.79   1.20
#> sep_rf_cv       611.22  47.36
#> sep_xgboost     792.17   1.17
#> sep_xgboost_cv  591.50  25.28
#> sur_lm          610.61   0.42
#> sur_splines     596.86   0.38
#> sur_tree        677.04   0.32
#> sur_tree_cv     789.37   3.31
#> sur_rf          414.15   0.58
#> sur_rf_cv       501.37  14.67
#> sur_xgboost     606.92   0.35
#> sur_xgboost_cv  429.06   2.59
