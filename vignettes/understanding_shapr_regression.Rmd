...
#>                      MSEv Time
#> MC_empirical       179.43 1.40
#> sep_lm             745.21 0.68
#> sep_pcr            784.91 0.78
#> sep_splines        165.13 0.73
#> sep_reicpe_example 687.45 1.43
```
...
#> sep_splines        165.13 0.73
#> sep_reicpe_example 687.45 1.43
#> sep_tree_stump     218.05 0.77
#> sep_tree_default   177.68 0.72
```
...
#> sep_tree_stump     218.05  0.77
#> sep_tree_default   177.68  0.72
#> sep_tree_cv        169.96 14.78
#> sep_tree_cv_2      166.17 30.75
#> sep_rf             210.99  1.20
#> sep_rf_cv          212.88 33.41
```
...
#> sep_rf               210.99  1.20
#> sep_rf_cv            212.88 33.41
#> sep_xgboost          197.72  0.98
#> sep_xgboost_cv       164.69 17.37
#> sep_xgboost_cv_par   164.69 11.15
#> sep_xgboost_cv_2_par 146.51 11.30
```
...
#> sep_xgboost_cv_2_par 146.51 11.30
#> sur_lm               649.61  0.25
#> sur_xgboost          169.92  0.31
#> sur_xgboost_cv       169.87  1.75
#> sur_rf               195.10  0.41
#> sur_rf_cv            171.84 24.38
#> sur_rf_cv_par        171.84 18.49
...
#> sur_rf_cv_par        171.84 18.49
#> sep_ppr              327.23  0.83
#> sep_ppr_cv           269.74 10.46
#> sur_ppr              395.42  0.22
#> sur_ppr_cv           415.62  1.42
...
#> MC_empirical         179.43  1.40
#> MC_gaussian          245.19  0.42
#> MC_copula            247.29  0.36
#> MC_ctree             191.82  1.53
#> MC_vaeac             141.88 51.22
#> sep_lm               745.21  0.68
#> sep_pcr              784.91  0.78
#> sep_splines          165.13  0.73
#> sep_reicpe_example   687.45  1.43
...
#>                   MSEv   Time
#> MC_independence 641.82   0.28
#> MC_ctree        554.50   1.58
#> MC_vaeac        629.43 121.57
#> sep_lm          550.06   0.93
#> sep_splines     541.36   1.01
#> sep_tree        753.84   0.67
#> sep_tree_cv     756.27  34.71
#> sep_rf          521.79   1.18
#> sep_rf_cv       609.58  55.10
#> sep_xgboost     792.17   1.02
#> sep_xgboost_cv  595.98  22.60
#> sur_lm          610.61   0.43
#> sur_splines     596.86   0.47
#> sur_tree        677.04   0.35
#> sur_tree_cv     789.37   3.25
#> sur_rf          414.15   0.45
#> sur_rf_cv       533.06  13.48
#> sur_xgboost     606.92   0.35
#> sur_xgboost_cv  429.06   1.97
