...
#>                      MSEv Time
#> MC_empirical       179.43 3.91
#> sep_lm             745.21 0.63
#> sep_pcr            784.91 0.78
#> sep_splines        165.13 0.78
#> sep_reicpe_example 687.45 1.45
```
...
#> sep_splines        165.13 0.78
#> sep_reicpe_example 687.45 1.45
#> sep_tree_stump     218.05 0.65
#> sep_tree_default   177.68 0.66
```
...
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 8 of 16.
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 10 of 16.
#> Results of the 5-fold cross validation (top 6 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 7 of 16.
#> Results of the 5-fold cross validation (top 6 best configurations):
...
#> 
#> Working on coalition with id 11 of 16.
#> Results of the 5-fold cross validation (top 6 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 9 of 16.
#> Results of the 5-fold cross validation (top 6 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 4 of 16.
...
#> 
#> Working on coalition with id 6 of 16.
#> Results of the 5-fold cross validation (top 6 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 5 of 16.
#> Results of the 5-fold cross validation (top 3 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 2 of 16.
#> Results of the 5-fold cross validation (top 3 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 3 of 16.
#> Results of the 5-fold cross validation (top 3 best configurations):
...
#> 
#> Working on coalition with id 13 of 16.
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 12 of 16.
#> Results of the 5-fold cross validation (top 9 best configurations):
...
#> 
#> Working on batch  of 10 in `prepare_data.regression_separate()`.
#> Working on coalition with id 14 of 16.
#> Results of the 5-fold cross validation (top 9 best configurations):
...
#> 
#> Working on coalition with id 15 of 16.
#> Results of the 5-fold cross validation (top 9 best configurations):
...
#> sep_tree_stump     218.05  0.65
#> sep_tree_default   177.68  0.66
#> sep_tree_cv        222.71 12.51
#> sep_tree_cv_2      219.45 25.58
#> sep_rf             217.00  1.25
#> sep_rf_cv          212.64 34.31
```
...
#> sep_rf               217.00  1.25
#> sep_rf_cv            212.64 34.31
#> sep_xgboost          197.72  0.76
#> sep_xgboost_cv       169.83 15.91
#> sep_xgboost_cv_par   169.83 12.52
#> sep_xgboost_cv_2_par 153.13 14.67
```
...
#> sep_xgboost_cv_2_par 153.13 14.67
#> sur_lm               649.61  0.30
#> sur_xgboost          169.92  0.32
#> sur_xgboost_cv       169.87  1.92
#> sur_rf               201.23  0.58
#> sur_rf_cv            172.09 26.76
#> sur_rf_cv_par        172.09 19.75
...
#> sur_rf_cv_par        172.09 19.75
#> sep_ppr              327.23  0.63
#> sep_ppr_cv           246.28 10.08
#> sur_ppr              395.42  0.29
#> sur_ppr_cv           415.62  1.46
...
#> MC_empirical         179.43  3.91
#> MC_gaussian          235.15  0.38
#> MC_copula            237.35  0.37
#> MC_ctree             190.82  2.05
#> MC_vaeac             145.06  2.08
#> sep_lm               745.21  0.63
#> sep_pcr              784.91  0.78
#> sep_splines          165.13  0.78
#> sep_reicpe_example   687.45  1.45
...
#> Error in get_k_best_methods(explanation_list, k = length(explanation_list)): cannot open file '/disk/home/jullum/Dropbox/Local_work/Git/shapr/vignettes/cache_regression/mixed-plot-2_c7a58bb245158664147f09c43048b7b3.rdb': No such file or directory
plot_MSEv_scores(explanation_list[order], method_line = "MC_empirical")
#> Error in "shapr" %in% class(explanation_list): cannot open file '/disk/home/jullum/Dropbox/Local_work/Git/shapr/vignettes/cache_regression/mixed-plot-2_c7a58bb245158664147f09c43048b7b3.rdb': No such file or directory
```
...
#> Error in get_k_best_methods(explanation_list, k = 5): cannot open file '/disk/home/jullum/Dropbox/Local_work/Git/shapr/vignettes/cache_regression/mixed-plot-2_c7a58bb245158664147f09c43048b7b3.rdb': No such file or directory
...
#> Error in if (any(names(explanation_list) == "")) stop("All the entries in `explanation_list` must be named."): missing value where TRUE/FALSE needed
```
...
#> MC_ctree        555.58  1.50
#> MC_vaeac        629.56  3.35
#> sep_lm          550.06  0.59
#> sep_splines     541.36  0.78
#> sep_tree        753.84  0.66
#> sep_tree_cv     756.27 27.17
#> sep_rf          518.27  1.31
#> sep_rf_cv       619.81 46.47
#> sep_xgboost     792.17  0.94
#> sep_xgboost_cv  595.98 19.43
#> sur_lm          610.61  0.30
#> sur_splines     596.86  0.33
#> sur_tree        677.04  0.34
#> sur_tree_cv     789.37  2.31
#> sur_rf          407.76  0.63
#> sur_rf_cv       520.63 13.36
#> sur_xgboost     606.92  0.35
#> sur_xgboost_cv  429.06  2.03
...
#> Error in get_k_best_methods(explanation_list_mixed, k = length(explanation_list_mixed)): cannot open file '/disk/home/jullum/Dropbox/Local_work/Git/shapr/vignettes/cache_regression/mixed-plot-2_c7a58bb245158664147f09c43048b7b3.rdb': No such file or directory
...
#> Error in "shapr" %in% class(explanation_list): lazy-load database '/disk/home/jullum/Dropbox/Local_work/Git/shapr/vignettes/cache_regression/mixed-plot-2_c7a58bb245158664147f09c43048b7b3.rdb' is corrupt
```
...
#> Error in get_k_best_methods(explanation_list_mixed, k = 5): lazy-load database '/disk/home/jullum/Dropbox/Local_work/Git/shapr/vignettes/cache_regression/mixed-plot-2_c7a58bb245158664147f09c43048b7b3.rdb' is corrupt
...
#> sep_lm      745.21  0.60
#> sep_pcr     784.91  0.77
#> sep_splines 165.13  0.81
#> sep_tree_cv 222.71 12.48
#> sep_rf_cv   212.64 34.18
#> sur_rf_cv   172.09 26.41
