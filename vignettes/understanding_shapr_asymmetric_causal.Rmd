...
# Conditioal Shapley values {#ConditionalSV}
Causal Shapley values are equivalent to conditional Shapley values when all $M$
features combined in a single component $\tau = \mathcal{M} = \{1,2,...,M\}$ and
...
as specified in @aas2019explaining.
...
explanation_sym_con_gaussian <-
  progressr::with_progress({
    explain(
      ...
      asymmetric = FALSE, # Default value
      causal_ordering = NULL, # Default value
      confounding = FALSE # Default value
    )
  })
```
