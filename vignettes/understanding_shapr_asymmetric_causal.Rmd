...
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:48:35 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a464fa07114.rds'
#> 
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:48:43 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: ctree
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4658259d3f.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:49:31 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: regression_separate
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4611c22b95.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> gaussian 1098008 77896.33        8.41
#> ctree    1095957 69223.49       48.06
#> xgboost  1154565 66463.44        9.68
```
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:49:43 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a461692bdc4.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:49:45 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
...
#> • Number of asymmetric coalitions: 20
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a462f1ea71.rds'
#> 
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:49:46 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: ctree
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Number of asymmetric coalitions: 20
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4629a738b5.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:49:55 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: regression_separate
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Number of asymmetric coalitions: 20
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a46751087c2.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#>                           MSEv  MSEv_sd Time (secs)
#> gaussian              330603.3 36828.70        2.00
#> gaussian_non_adaptive 306457.7 35411.60        1.52
#> ctree                 260562.1 29428.95        8.81
#> xgboost               307562.1 39362.81        1.58
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:49:59 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a46501da821.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:50:10 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: independence
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend, cosyear, sinyear, temp, atemp, windspeed, hum}
#> • Components with confounding: {trend, cosyear, sinyear, temp, atemp, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a465c7ea1a0.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:50:18 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: independence
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4621d8b226.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#>                      MSEv  MSEv_sd Time (secs)
#> gaussian          1383295 111844.8       10.30
#> independence_marg 1382080 111150.6        7.97
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:50:29 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: FALSE
#> • Number of feature-wise Shapley values: 7
...
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a46543d93b8.rds'
#> 
#> ── Main computation started ──
#> 
...
#> and is therefore set to 2^n_features = 128.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:50:58 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: copula
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4610427500.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#>             MSEv  MSEv_sd Time (secs)
#> gaussian 1113795 85800.41       29.47
#> copula   1137608 88376.95       20.88
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:51:20 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a466caceec.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:51:22 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: copula
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a46589a72e2.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 08:51:26 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: ctree
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a46714e6777.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> ordering 20, and is therefore set to 20.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:25:12 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: vaeac
#> • Adaptive estimation: FALSE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a467fe13008.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 20 of 20 coalitions.
...
#> Assuming feature classes from the data are correct.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:08 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4642c9ad9d.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> Assuming feature classes from the data are correct.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:19 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a462f6b85d1.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:24 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
...
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a464a7163a7.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> and is therefore set to 2^n_groups = 64.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:31 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of group-wise Shapley values: 6
#> • Number of observations to explain: 144
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a466ca3018d.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:36 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of group-wise Shapley values: 6
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp_group, windspeed, hum}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a461454c39e.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> and is therefore set to 2^n_groups = 64.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:38 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of group-wise Shapley values: 6
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp_group, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a463b8ad0c3.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
...
#> ordering 12, and is therefore set to 12.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 09:33:46 ───────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of group-wise Shapley values: 6
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp_group, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpGRskpn/shapr_obj_156a4644ccb08d.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ──────────────────────────────────────────────────────────────────────────────────────────────────
