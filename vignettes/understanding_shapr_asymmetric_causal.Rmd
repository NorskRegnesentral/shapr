...
#> gaussian 1098008   77896        8.41
#> ctree    1095957   69223       48.06
#> xgboost  1154565   66463        9.68
```
...
#>                         MSEv MSEv_sd Time (secs)
#> gaussian              330603   36829        2.00
#> gaussian_non_adaptive 306458   35412        1.52
#> ctree                 260562   29429        8.81
#> xgboost               307562   39363        1.58
...
#>             MSEv MSEv_sd Time (secs)
#> gaussian 1113795   85800       29.47
#> copula   1137608   88377       20.88
...
#> Assuming feature classes from the data are correct.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 19:57:27 ────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpXJrOHV/shapr_obj_15a809422e367d.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────────────────
...
#> Assuming feature classes from the data are correct.
#> 
#> ── Starting `shapr::explain()` at 2024-10-11 19:57:40 ────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • Adaptive estimation: TRUE
#> • Number of feature-wise Shapley values: 7
...
#> • Causal ordering: {trend}, {cosyear, sinyear}, {temp, atemp, windspeed, hum}
#> • Components with confounding: {cosyear, sinyear}
#> • Computations (temporary) saved at: '/tmp/RtmpXJrOHV/shapr_obj_15a8091798d878.rds'
#> 
#> ── Adaptive computation started ──
#> 
#> ── Iteration 1 ───────────────────────────────────────────────────────────────────────────────────────
...
#>   1: 0.00 (0.00)  -2181.91 (374.04)   -825.541 (352.22)  -236.730 (257.69)   -33.813 ( 53.47) 
#>   2: 0.00 (0.00)  -2174.36 (371.76)   -846.615 (359.93)  -187.083 (274.61)   -44.966 ( 55.78) 
#>   3: 0.00 (0.00)  -2088.96 (360.14)   -793.628 (341.68)  -186.335 (247.79)  -104.809 ( 41.77) 
#>   4: 0.00 (0.00)  -2103.36 (368.62)   -798.135 (356.43)  -110.331 (268.86)   169.736 (102.28) 
#>   5: 0.00 (0.00)  -2003.88 (349.11)   -723.936 (323.40)  -231.863 (226.28)    36.505 ( 31.04) 
#>  ---                                                                                          
#> 140: 0.00 (0.00)   1575.95 (585.55)  -1014.078 (542.93)   236.336 (357.62)   -68.170 (206.64) 
#> 141: 0.00 (0.00)   1588.69 (607.20)  -1057.223 (537.25)    33.370 (256.33)     1.919 ( 28.84) 
#> 142: 0.00 (0.00)   1466.74 (593.37)  -1109.151 (522.54)   -96.687 (257.10)   -44.555 ( 72.30) 
#> 143: 0.00 (0.00)   1003.94 (616.41)  -1780.473 (602.42)  -101.586 (368.10)    19.062 ( 60.30) 
#> 144: 0.00 (0.00)    711.14 (724.53)  -2635.898 (777.15)  -178.609 (570.02)    36.623 (145.89) 
#>                   atemp           windspeed                 hum
#>                  <char>              <char>              <char>
