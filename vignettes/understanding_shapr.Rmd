...
# Creating an AR(2) predictive model.
ar2_model <- ar(data_ts, order = 2)

# Setting prediction zero as the mean of the data for each forecast point.
p0_ar <- rep(mean(data_ts$Y), 3)

# Explain two forecasts, starting at T = 499 and T 500.
