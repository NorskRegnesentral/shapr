...
to only plot certain combinations and/or test observations. See the documentation of the `make_MSEv_eval_crit_plots()` function for several examples.

```{r, echo=FALSE, message=FALSE, results='hide'}
make_MSEv_eval_crit_plots(explanation_list_named, N_sd_error_bars = 1) +
