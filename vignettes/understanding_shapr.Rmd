...
> [Parallelization and progress updates](#paraprog)
...
`future` and `progressr` packages, see [Parallelization and progress updates](#paraprog) for details.
...
# Parallelization and progress updates
...
#> Note: Feature classes extracted from the model contains NA.
#> Assuming feature classes from the data are correct.
#> Error in check_vs_prev_shapr_object(internal): Convergence reached before estimation start.
...
#> [1] "/tmp/RtmpwjZFOu/shapr_obj_1f6d1468eed09.rds"
