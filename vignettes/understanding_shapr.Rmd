...
# the no-covariate effect. 
plot(explanation_combined, plot_phi0 = FALSE, index_x_test = c(1,6))
# Note that this is an explanation of a different (but similar) model that the xgboost model explained above!
