...
like a vector of fixed $\sigma$ values can be specified through the argument `sigma_vec`. See `?explain` for more 
information. If `approach = "gaussian"`, we may specify the mean vector and covariance matrix of the data 
