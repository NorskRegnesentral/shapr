...
# Look at the main plot
plots_named$bar_plot_MSEv

# We can also remove the legend which is not need for the main plot, but essential for the other plots
make_MSEv_evaluation_criterion_plots(explanation_list_named, legend_position = "none")$bar_plot_MSEv
```
...
plots_named_v2 <- make_MSEv_evaluation_criterion_plots(
  ...
  index_combinations = c(1:3, 11, 13),
