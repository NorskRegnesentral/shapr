...
We can specify the `index_x_explain` and `id_combination` parameters in `make_MSEv_eval_crit_plots()` to only plot 
...
See the documentation of the `make_MSEv_eval_crit_plots()` function for more examples.
...
MSEv_plot +
  ...
  ggplot2::geom_text(ggplot2::aes(label = sprintf(paste("%.", sprintf("%d", bar_text_n_decimals), "f", sep = ""),
                     ...
                     hjust = 1.15, # This number might need altering for different plots sizes
                     color = "black",
