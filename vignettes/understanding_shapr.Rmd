...
airquality_train <- airquality[-(1:6),]
airquality_test <- airquality[1:6,]

x_train_cat <- airquality_train[, x_var_cat]
x_test_cat <- airquality_test[, x_var_cat]
...
model_lm_cat <- lm(lm_formula,airquality_train)

p <- mean(airquality_train[,y_var])
