...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  eval = FALSE # Temporary don't run the chunks in the vignette at all for fast building
)
```
...
vaeac_plot_evaluation_criterion(list("Vaeac 3 epochs" = explanation_vaeac),
  plot_type = "method"
)
```
