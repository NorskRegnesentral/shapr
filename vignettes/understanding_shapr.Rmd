...
The latter is found at `SHAPR_OBJ$internal$parameters$saving_path`, defaults to a temporary folder,
...
print(ex_further$internal$parameters$saving_path)
...
ex_even_further <- explain(
  ...
  prev_shapr_object = ex_further$internal$parameters$saving_path
)
#> Note: Feature classes extracted from the model contains NA.
#> Assuming feature classes from the data are correct.
#> Success with message:
