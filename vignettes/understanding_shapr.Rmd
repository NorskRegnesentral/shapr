...
# Plot the resulting explanations for observations 1 and 6
plot(explanation_gaussian, bar_plot_phi0 = FALSE, index_x_explain = c(1, 6))
```
...
plot(explanation_copula, bar_plot_phi0 = FALSE, index_x_explain = c(1, 6))
```
...
# Plot the resulting explanations for observations 1 and 6, excluding 
# the no-covariate effect
plot(explanation_ctree, bar_plot_phi0 = FALSE, index_x_explain = c(1, 6))
```
