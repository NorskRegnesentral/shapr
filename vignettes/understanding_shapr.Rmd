...
for more information. If `approach = "gaussian"`, we may specify the mean vector and covariance matrix of the data 
...
which method to use when conditioning on `i` features. The below code exemplifies this approach for the four features, 
