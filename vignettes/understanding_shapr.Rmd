...
Moreover, the default behavior is to estimate the Shapley values iteratively/iteratively, with increasing number of
...
The `t` value controls the convergence tolerance, defaults to 0.02, and can be set through the `iterative_args$convergence_tolerance` argument, see [iterative estimation](#iterative) for more details.
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:03:47 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c1876451ac64e.rds'
#> 
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:03:51 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 111
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18766d271f51.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:03:59 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <lm>
#> • Approach: ctree
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c1876d108055.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:00 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <lm>
#> • Approach: ctree
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18761fdca59c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:01 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <lm>
#> • Approach: categorical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18766a1742b.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:02 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <lm>
#> • Approach: timeseries
#> • iterative estimation: FALSE
#> • Number of group-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18765c67f37.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:04 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: independence
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187615909571.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:05 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187669394043.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:09 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c1876196cf612.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187610b52b5a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187636ab1203.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
ex <- explain(
  ...
  prediction_zero = p0,
  iterative = TRUE,
  iterative_args = list(convergence_tolerance = 0.1)
)
#> Note: Feature classes extracted from the model contains NA.
#> Assuming feature classes from the data are correct.
#> Success with message:
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:13 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • iterative estimation: TRUE
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18761c624bbf.rds'
#> 
...
#> 
#> ── Iteration 5 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Using 22 of 32 coalitions, 6 new.
#> 
#> ── Iteration 6 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Using 26 of 32 coalitions, 4 new.
#> 
#> ── Iteration 7 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Using 28 of 32 coalitions, 2 new.
#> 
#> ── Iteration 8 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Using 30 of 32 coalitions, 2 new.
```
...
`iterative_args$max_batch_size` (defaults to 10) and
`iterative_args$min_n_batches` (defaults to 10).
...
#> and is therefore set to 2^n_features = 32.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:21 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187625c75286.rds'
#> 
#> ── Main computation started ──
#> 
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:24 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: empirical, copula, and gaussian
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c1876ed292f2.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:26 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: ctree, ctree, and empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187631b56c11.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:27 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of group-wise Shapley values: 2
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187646237fdf.rds'
#> 
#> ── Main computation started ──
#> 
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:29 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <gbm>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187675d1a955.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:32 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <gbm>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18764d3e2d93.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> and is therefore set to 2^n_features = 16.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:36 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <workflow>
#> • Approach: empirical
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c1876330edd61.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
The latter is found at `SHAPR_OBJ$internal$parameters$iterative_args$saving_path`, defaults to a temporary folder,
...
#> Assuming feature classes from the data are correct.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:39 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • iterative estimation: TRUE
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c18767c70b709.rds'
#> 
#> ── iterative computation started ──
#> 
#> ── Iteration 1 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
ex_further <- explain(
  ...
  prediction_zero = p0,
  max_n_coalitions = 25,
  iterative_args = list(convergence_tolerance = 0.005), # Decrease the convergence threshold
  prev_shapr_object = ex_init
)
#> Note: Feature classes extracted from the model contains NA.
#> Assuming feature classes from the data are correct.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:41 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c1876481fd8a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 26 of 32 coalitions.

print(ex_further$internal$parameters$iterative_args$saving_path)
#> [1] "/tmp/RtmpPIciRY/shapr_obj_c1876481fd8a.rds"
...
ex_even_further <- explain(
  ...
  prev_shapr_object = ex_further$internal$parameters$iterative_args$saving_path
)
#> Note: Feature classes extracted from the model contains NA.
#> Assuming feature classes from the data are correct.
#> Success with message:
...
#> and is therefore set to 2^n_features = 32.
#> 
#> ── Starting `shapr::explain()` at 2024-10-05 23:04:42 ─────────────────────────────────────────────────────────────────────────────────────
#> • Model class: <xgb.Booster>
#> • Approach: gaussian
#> • iterative estimation: FALSE
#> • Number of feature-wise Shapley values: 5
#> • Number of observations to explain: 6
#> • Computations (temporary) saved at: '/tmp/RtmpPIciRY/shapr_obj_c187699a1121.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 32 of 32 coalitions.
