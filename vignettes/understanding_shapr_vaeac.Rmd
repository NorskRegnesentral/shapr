...
make_vaeac_training_evaluation_plots(list(
  "Regular samp." = explanation_paired_sampling_FALSE,
...
rbind(
  "time_paired_sampling" = explanation_paired_sampling_TRUE$timing$timing_secs,
...
vaeac_ggpairs_plot_imputed_and_true_data_shapr(
  explanation = explanation_litle_training,
...
explanation_train_more$internal$parameters$vaeac <-
  vaeac_continue_train_model(
    explanation = explanation_train_more,
    epochs_new = 5,
...
make_vaeac_training_evaluation_plots(list(
  "Original" = explanation_litle_training,
...
explanation_train_even_more$internal$parameters$vaeac <-
  vaeac_continue_train_model(
    explanation = explanation_train_even_more,
    epochs_new = 10,
    training_data = x_train,
    verbose = TRUE
  )
...
explanation_early_stopping_train_more$internal$parameters$vaeac <-
  vaeac_continue_train_model(
    explanation = explanation_early_stopping_train_more,
    epochs_new = 15,
    training_data = x_train,
    verbose = TRUE
  )
...
# Look at the training and validation errors.
make_vaeac_training_evaluation_plots(list(
  "Vaeac early stopping" = explanation_early_stopping,
...
make_vaeac_training_evaluation_plots(list(
  "Vaeac w.o. skip-con." = explanation_vaeac,
