...
explanation <- explain(
  ...
  vaeac.extra_parameters = list(
    ...
    vaeac.save_every_nth_epoch = 123,
    vaeac.masking_ratio = 123,
    vaeac.batch_size = 123,
    vaeac.depth = 123,
...
plot_several_vaeacs_VLB_IWAE(explanation_list)
...
plot_several_vaeacs_VLB_IWAE(list("Original" = expl_litle_training))
...
plot_several_vaeacs_VLB_IWAE(list(
...
plot_several_vaeacs_VLB_IWAE(list("Vaeac early stopping" = expl_early_stopping))
```
...
plot_several_vaeacs_VLB_IWAE(list("Simple vaeac" = expl_vaeac))
