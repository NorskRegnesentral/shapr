...
explanation <- explain(
  ...
  vaeac.n_vaeacs_initialize = 2,
  vaeac.width = 16,
  vaeac.save_every_nth_epoch = 10000000,
  vaeac.blaa2 = 1000000000,
  vaeac.extra_parameters = list(
    vaeac.width = 1000000000,
    vaeac.save_every_nth_epoch = 8,
    vaeac.masking_ratio = 0.7,
    vaeac.batch_size = 32,
    vaeac.depth = 2,
    vaeac.blaa = 1000000000
  )
)
```
...
vaeac_plot_evaluation_criterion(explanation_list)
...
vaeac_plot_evaluation_criterion(list("Original" = expl_litle_training))
...
vaeac_plot_evaluation_criterion(list(
...
vaeac_plot_evaluation_criterion(list("Vaeac early stopping" = expl_early_stopping))
```
...
vaeac_plot_evaluation_criterion(list("Simple vaeac" = expl_vaeac))
