...
plot_vaeac_training_evaluation(explanation_list)
...
plot_vaeac_training_evaluation(expl_litle_training)
...
plot_vaeac_training_evaluation(list(
...
plot_vaeac_training_evaluation(list("Vaeac early stopping" = expl_early_stopping))
```
...
plot_vaeac_training_evaluation(list("Simple vaeac" = expl_vaeac))
