...
![plot of chunk first-vaeac-plots](figure/first-vaeac-plots-1.png)
...
![plot of chunk check-n_combinations-and-more-batches](figure/check-n_combinations-and-more-batches-1.png)
...
![plot of chunk paired sampling plotting](figure/paired sampling plotting-1.png)

```r
plot_MSEv_eval_crit(explanation_list)
```

![plot of chunk paired sampling plotting](figure/paired sampling plotting-2.png)
...
#> Paired  0.06571436      0.04333425          9.018855  0.3187792         0.004562378
#> Regular 0.04860353      0.03768158          7.413082  0.3773353         0.004824638
```
...
![plot of chunk continue-training](figure/continue-training-1.png)
...
![plot of chunk continue-training](figure/continue-training-2.png)
...
![plot of chunk continue-training](figure/continue-training-3.png)
...
![plot of chunk continue-training](figure/continue-training-4.png)
...
![plot of chunk continue-training](figure/continue-training-5.png)
...
![plot of chunk continue-training](figure/continue-training-6.png)
...
![plot of chunk continue-training](figure/continue-training-7.png)
...
![plot of chunk early-stopping-1](figure/early-stopping-1-1.png)
...
![plot of chunk early-stopping-2](figure/early-stopping-2-1.png)
...
![plot of chunk early-stopping-3](figure/early-stopping-3-1.png)
...
![plot of chunk early-stopping-3](figure/early-stopping-3-2.png)
...
![plot of chunk vaeac-grouping-of-features](figure/vaeac-grouping-of-features-1.png)
...
![plot of chunk vaeac-mixed-data](figure/vaeac-mixed-data-1.png)
...
![plot of chunk vaeac-mixed-data](figure/vaeac-mixed-data-2.png)
...
![plot of chunk vaeac-mixed-data](figure/vaeac-mixed-data-3.png)
