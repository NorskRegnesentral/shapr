...
explanation$internal$parameters$vaeac$model # Look at the possible vaeac models. We use `best` below
...
# Look at the training and validation errors. We see some improvment
vaeac_plot_evaluation_criteria(list(
