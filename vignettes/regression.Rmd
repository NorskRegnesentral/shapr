...
# `shapr::`
# prefix when calling explain(). The `conflicted` package is imported by
# `tidymodels`.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:29 ───────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44633628c.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:34 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af447962d2ed.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:36 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444b5c838.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af445ec88ad5.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
regression.recipe_func <- function(recipe) {
  ...
  # If Wind is present, then scale it to be between 0 and 1 and then sqrt transform
  # it
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:37 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4479967c87.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>                      MSEv Time
#> MC_empirical       188.54 5.44
#> sep_lm             715.79 0.82
#> sep_pcr            761.31 0.88
#> sep_splines        179.15 0.90
#> sep_recipe_example 680.72 1.33
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:39 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441e42116f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:40 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4437179d40.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:18:41 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444490cf24.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:19:00 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441d013683.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:19:36 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442334990f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:19:37 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44147d4d99.rds'
#> 
...
#> sep_tree_stump     196.95  0.77
#> sep_tree_default   190.77  0.76
#> sep_tree_cv        232.46 18.99
#> sep_tree_cv_2      241.85 36.09
#> sep_rf             218.68  1.24
#> sep_rf_cv          222.80 37.03
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:20:15 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af447b2ee6f3.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:20:16 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442561f5ea.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:20:38 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441012992d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:20:52 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44397d8608.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_rf               218.68  1.24
#> sep_rf_cv            222.80 37.03
#> sep_xgboost          256.64  1.00
#> sep_xgboost_cv       228.70 21.46
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:21:06 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af445e902ffe.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4455750cd6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:21:07 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4441107acb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:21:10 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444b2abd15.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:21:11 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4437c1fae4.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:21:43 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4451fe0aff.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> sep_xgboost_cv_2_par 221.63 13.12
#> sur_lm               615.22  0.60
#> sur_xgboost          282.86  0.65
#> sur_xgboost_cv       232.34  3.00
#> sur_rf               176.26  0.89
#> sur_rf_cv            177.16 31.06
#> sur_rf_cv_par        177.16 16.43
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:00 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444921def3.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:01 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444f8ddc54.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:17 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441d9d8275.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4459347820.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sur_rf_cv_par        177.16 16.43
#> sep_ppr              316.08  0.76
#> sep_ppr_cv           274.26 15.60
#> sur_ppr              307.53  0.51
#> sur_ppr_cv           329.20  2.11
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:20 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442aa8f6cc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:21 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af447d914142.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af447c275f57.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:22 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441b3e1a14.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:22:24 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4437590f53.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
print_MSEv_scores_and_time(explanation_list)
#>                        MSEv   Time
#> MC_independence      233.48   1.15
#> MC_empirical         188.54   5.44
#> MC_gaussian          214.11   0.50
#> MC_copula            214.78   0.53
#> MC_ctree             200.08   1.99
#> MC_vaeac             192.98 114.13
#> sep_lm               715.79   0.82
#> sep_pcr              761.31   0.88
#> sep_splines          179.15   0.90
#> sep_recipe_example   680.72   1.33
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:24:22 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444166c54e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:24:23 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4420173c7c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:24:25 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4456b3aea2.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:27:33 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441a59bf4f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:27:34 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442e488d49.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:27:35 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442f7080a1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4437f741c4.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:28:16 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4477d056a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:28:18 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44139242a0.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:07 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442922b288.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:09 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4467035b4b.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:42 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4464949c8d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4430bd29eb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:43 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af446f09c368.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:44 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af441bedabe1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:47 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44b74b940.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:29:48 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af445fbcea52.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:30:03 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44145735ff.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:30:04 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44315705aa.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#>                   MSEv   Time
#> MC_independence 641.82   0.93
#> MC_ctree        555.58   2.16
#> MC_vaeac        623.53 186.82
#> sep_lm          550.06   0.82
#> sep_splines     541.36   1.02
#> sep_tree        753.84   0.91
#> sep_tree_cv     756.27  40.80
#> sep_rf          523.61   1.34
#> sep_rf_cv       596.04  49.73
#> sep_xgboost     760.08   1.25
#> sep_xgboost_cv  615.92  32.79
#> sur_lm          610.61   0.60
#> sur_splines     596.86   0.68
#> sur_tree        677.04   0.62
#> sur_tree_cv     789.37   3.36
#> sur_rf          406.06   0.96
#> sur_rf_cv       526.63  15.35
#> sur_xgboost     809.53   0.80
#> sur_xgboost_cv  518.44   3.26
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:30:10 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af443390b780.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af447f6185fc.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:30:11 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af4450e014f3.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:30:12 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af444dea76cf.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:30:31 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af442daa1346.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-04 08:31:09 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpXO5NQl/shapr_obj_38af44509594.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_tree_cv 232.46 19.23
#> sep_rf_cv   222.80 37.48
#> sur_rf_cv   177.16 30.12
