...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:38 ──────────────────────────
...
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d291e035a.rds'
#>
#>
#>
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:45 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d19c7f834.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:46 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d2e2b33ff.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:47 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d1c02f259.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:48 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3dc358a7.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:49 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5f7e75bb.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:50 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d222ad054.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sep_splines        179.15 0.93
#> sep_recipe_example 680.72 1.39
#> sep_tree_stump     196.95 0.78
#> sep_tree_default   190.77 0.78
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:44:51 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3e8b3f30.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:45:11 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4ed14ffb.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:45:48 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d77ef5356.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:45:49 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5604a14c.rds'
#>
...
#> sep_tree_stump     196.95  0.78
#> sep_tree_default   190.77  0.78
#> sep_tree_cv        232.46 19.51
#> sep_tree_cv_2      241.85 36.92
#> sep_rf             218.68  1.23
#> sep_rf_cv          222.80 38.32
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:46:27 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d6b3793d8.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:46:28 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5d825ac6.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:46:52 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d70108018.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:47:05 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d7940fa73.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sep_rf               218.68  1.23
#> sep_rf_cv            222.80 38.32
#> sep_xgboost          256.64  1.11
#> sep_xgboost_cv       228.70 22.63
#> sep_xgboost_cv_par   228.70 12.77
#> sep_xgboost_cv_2_par 221.63 13.07
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:47:19 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3c6241f9.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:47:20 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5f3d2d70.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d46da13b2.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:47:23 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d60e2f7ec.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:47:24 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3b1855b5.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:47:55 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d24924e4b.rds'
#>
#>
#>
#> ── Main computation started ──
...
#> sur_rf               176.26  0.94
#> sur_rf_cv            177.16 30.24
#> sur_rf_cv_par        177.16 16.26
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:12 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d71aa9719.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:13 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d7562faba.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:29 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5410c82f.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:30 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d61bb1731.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sur_rf_cv_par        177.16 16.26
#> sep_ppr              316.06  0.75
#> sep_ppr_cv           274.25 16.41
#> sur_ppr              429.73  0.54
#> sur_ppr_cv           429.73  2.17
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:32 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d124fa17b.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:33 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3a2db4d3.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d2cb099a0.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:34 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d2dbb6c43.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:48:36 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4efe6ebd.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> MC_copula            214.78   0.60
#> MC_ctree             200.08   1.75
#> MC_vaeac             192.98 117.07
#> sep_lm               715.79   0.69
#> sep_pcr              761.31   0.89
#> sep_splines          179.15   0.93
#> sep_recipe_example   680.72   1.39
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:50:36 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5aa89d72.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:50:37 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d2e883428.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:50:40 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d152958f1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:53:54 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d61ff9aee.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:53:55 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d607b70df.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:53:56 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d1e7e4eb7.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:53:57 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d3610631d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:54:37 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d42368811.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:54:38 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d376fbb5d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:55:29 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4f1f0a26.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:55:30 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d69b304b3.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:04 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d23e0b986.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:05 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d17321d42.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:06 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3df2a17e4.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d72df2843.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:10 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d44f8db.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:11 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d1c22b197.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:26 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d8b7aab3.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:27 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d4a3acc61.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>                   MSEv   Time
#> MC_independence 641.82   0.95
#> MC_ctree        555.58   2.40
#> MC_vaeac        623.53 194.24
#> sep_lm          550.06   0.75
#> sep_splines     541.36   1.09
#> sep_tree        753.84   0.85
#> sep_tree_cv     756.27  40.14
#> sep_rf          523.61   1.31
#> sep_rf_cv       596.04  50.55
#> sep_xgboost     760.08   1.30
#> sep_xgboost_cv  615.92  34.21
#> sur_lm          610.61   0.64
#> sur_splines     596.86   0.74
#> sur_tree        677.04   0.70
#> sur_tree_cv     789.37   3.54
#> sur_rf          406.06   0.98
#> sur_rf_cv       526.63  15.58
#> sur_xgboost     809.53   0.88
#> sur_xgboost_cv  518.44   3.63
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:32 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#>
#>
...
#>
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d7ba1e046.rds'
#>
#>
#>
#> ── Main computation started ──
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:33 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d2eac15b1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:34 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5b1c1dd7.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:35 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d5da17b34.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:56:54 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3df278690.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-07 21:57:32 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#>
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpuzSVRD/shapr_obj_8cd3d799a6c8e.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sep_tree_cv 232.46 19.25
#> sep_rf_cv   222.80 37.97
#> sur_rf_cv   177.16 30.66
