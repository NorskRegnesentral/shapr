...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:18 ──────────────────────────────────────────────
...
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf057ead2bf.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:24 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf07b56b9b1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:25 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf066cdf724.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:26 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0d74932d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:27 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf05dcdad4.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>                      MSEv Time
#> MC_empirical       188.54 6.05
#> sep_lm             715.79 0.73
#> sep_pcr            761.31 0.92
#> sep_splines        179.15 0.95
#> sep_recipe_example 680.72 1.39
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:29 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf04d2e1f7c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0751f2f55.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_splines        179.15 0.95
#> sep_recipe_example 680.72 1.39
#> sep_tree_stump     196.95 0.82
#> sep_tree_default   190.77 0.83
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:31 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0278b6dbc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:43:51 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf05aae3d12.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:44:28 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf032990fd1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:44:29 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf07006ff29.rds'
#> 
...
#> sep_tree_cv_2      241.85 37.04
#> sep_rf             218.68  1.30
#> sep_rf_cv          222.80 38.41
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:45:08 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0105444c9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:45:09 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf01ae7d8b8.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:45:31 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0674c9333.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:45:45 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf038aa3ce1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_rf               218.68  1.30
#> sep_rf_cv            222.80 38.41
#> sep_xgboost          256.64  1.03
#> sep_xgboost_cv       228.70 22.31
#> sep_xgboost_cv_par   228.70 12.87
#> sep_xgboost_cv_2_par 221.63 13.06
```
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:45:59 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0612ef906.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf07998872f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:46:00 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0565b4346.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:46:03 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf067093623.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:46:04 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf01f5722d6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:46:34 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf022d05149.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> sep_xgboost_cv_2_par 221.63 13.06
#> sur_lm               615.22  0.58
#> sur_xgboost          282.86  0.59
#> sur_xgboost_cv       232.34  2.94
#> sur_rf               176.26  0.91
#> sur_rf_cv            177.16 30.11
#> sur_rf_cv_par        177.16 16.33
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:46:52 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf03c6217a5.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0138a7639.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:47:09 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf07a73bbad.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf023aeaad8.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sur_rf_cv_par        177.16 16.33
#> sep_ppr              316.08  0.80
#> sep_ppr_cv           274.26 16.30
#> sur_ppr              307.53  0.54
#> sur_ppr_cv           329.20  2.23
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:47:12 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf056c3ab59.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:47:13 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf03093333.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0784942fb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:47:14 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf048d178f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:47:15 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf072f990eb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
print_MSEv_scores_and_time(explanation_list)
#>                        MSEv   Time
#> MC_independence      233.48   0.76
#> MC_empirical         188.54   6.05
#> MC_gaussian          214.11   0.56
#> MC_copula            214.78   0.57
#> MC_ctree             200.08   1.70
#> MC_vaeac             192.98 118.50
#> sep_lm               715.79   0.73
#> sep_pcr              761.31   0.92
#> sep_splines          179.15   0.95
#> sep_recipe_example   680.72   1.39
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:49:17 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf018c9b4e9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:49:18 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf057cefb50.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:49:20 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf056322695.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:52:34 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf032dd0a4c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:52:35 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf076a60b7c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:52:37 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf07e3378e6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:52:38 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02d50c5fa.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:53:17 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf01a54b654.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:53:18 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0214d4a0f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:07 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf04b6a3472.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:08 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf06e9417bc.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:42 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0719d4af0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0b1075e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:43 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf026baf75a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:44 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf06496dbdb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:47 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf05a29435f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:54:48 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf024e09619.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:03 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf02debb00c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:04 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf01aaab584.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#>                   MSEv   Time
#> MC_independence 641.82   0.91
#> MC_ctree        555.58   2.13
#> MC_vaeac        623.53 194.05
#> sep_lm          550.06   0.97
#> sep_splines     541.36   1.24
#> sep_tree        753.84   1.11
#> sep_tree_cv     756.27  39.08
#> sep_rf          523.61   1.32
#> sep_rf_cv       596.04  49.07
#> sep_xgboost     760.08   1.25
#> sep_xgboost_cv  615.92  33.21
#> sur_lm          610.61   0.62
#> sur_splines     596.86   0.74
#> sur_tree        677.04   0.66
#> sur_tree_cv     789.37   3.49
#> sur_rf          406.06   0.97
#> sur_rf_cv       526.63  14.84
#> sur_xgboost     809.53   1.29
#> sur_xgboost_cv  518.44   3.29
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:09 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> 
#> 
...
#> • Number of observations to explain: 20
#> 
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf03c4019d9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:10 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0667aabfe.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:11 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf0248c923b.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:12 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf06f1d2425.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:55:31 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf05d20b77a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2026-06-03 16:56:10 ──────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore set to
#>   `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/Rtmp1oDRWT/shapr_obj_33abf022c00b21.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_tree_cv 232.46 19.77
#> sep_rf_cv   222.80 38.33
#> sur_rf_cv   177.16 30.42
