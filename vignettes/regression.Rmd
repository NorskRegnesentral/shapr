...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:16 ───────────────────────────────────────────────────────
...
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95202e8c45b5.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:21 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952036941c15.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:23 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95205c2f460e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:24 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520573435dc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952070893ef.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>     MSEv   Time   <NA>   <NA>   <NA>
#> 1 179.43 745.21 784.91 165.13 687.45
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:26 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952034742195.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:27 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95207698280c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
# Print the MSEv scores and the elapsed time (in seconds) for the different methods
print_MSEv_scores_and_time(explanation_list)
#>     MSEv   Time   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 179.43 745.21 784.91 165.13 687.45 218.05 177.68
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:28 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520176d27f3.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:38 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952046a53b70.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:58 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95208e63cda.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:37:59 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95207c792ad8.rds'
#> 
...
# Print the MSEv scores and the elapsed time (in seconds) for the different methods
print_MSEv_scores_and_time(explanation_list)
#>     MSEv   Time   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 179.43 745.21 784.91 165.13 687.45 218.05 177.68 222.71 219.45 218.13 226.42
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:22 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952055e3bf0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:23 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952072b57aa6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:36 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95206abe47eb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:49 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952033aa10d5.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
# Print the MSEv scores and the elapsed time (in seconds) for the different methods
print_MSEv_scores_and_time(explanation_list)
#>     MSEv   Time   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 179.43 745.21 784.91 165.13 687.45 218.05 177.68 222.71 219.45 218.13 226.42 197.72 168.45 168.45 155.02
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:56 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95201a3b62ca.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:57 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520105c2395.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95204111225a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:38:59 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952053b578b1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:39:00 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952074873ed6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:39:18 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952027b6ba0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 1 179.43 745.21 784.91 165.13 687.45 218.05 177.68 222.71 219.45 218.13 226.42 197.72 168.45 168.45 155.02
#>     <NA>   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 649.61 169.92 169.87 192.12 183.39 183.39
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:39:53 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952053571a9b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520383453ee.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:40:01 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952077216e8f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:40:02 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952058a4efa.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 1 649.61 169.92 169.87 192.12 183.39 183.39 327.23 246.28 395.42 415.62
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:40:04 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520c4c4532.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:40:05 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952059112c6d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:40:06 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952065644190.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95207748191a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:40:08 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952045a73929.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
print_MSEv_scores_and_time(explanation_list)
#>     MSEv   Time   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 206.92 179.43 235.15 237.35 190.82 145.06 745.21 784.91 165.13 687.45 218.05 177.68 222.71 219.45 218.13
#>     <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 226.42 197.72 168.45 168.45 155.02 649.61 169.92 169.87 192.12 183.39 183.39 327.23 246.28 395.42 415.62
...
#> Error in if (any(names(explanation_list) == "")) cli::cli_abort("All the entries in `explanation_list` must be named."): missing value where TRUE/FALSE needed
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:41:48 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520e70566d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:41:49 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95201b0e4f90.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:41:50 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952062463324.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:44:14 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95206e601efd.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:44:15 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95208583260.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95203aed228a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:44:16 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952068535fc8.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:44:38 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952022e91139.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:44:39 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952042a2f09.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:04 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952046dc4b7d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:05 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95206fb9958.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:38 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520712d687e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:39 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95207d5b908.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952017286984.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:40 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520ba96b3f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:42 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952055c2b9b.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:43 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95203d8d125a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:51 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952069f53f50.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:45:52 ───────────────────────────────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520502e3a73.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#>     MSEv   Time   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>   <NA>
#> 1 641.82 555.58 629.56 550.06 541.36 753.84 756.27 523.61 636.46 792.17 595.64 610.61 596.86 677.04 789.37
#>     <NA>   <NA>   <NA>   <NA>
#> 1 406.17 521.25 742.54 541.19
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:46:15 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95204f784e13.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:46:16 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_9520577a3552.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:46:17 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952050963794.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:46:18 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952012a761f9.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:46:27 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_952060523688.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-07 18:46:47 ───────────────────────────────────────────────────────
#> ℹ Feature classes extracted from the model contains `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than or `2^n_features = 16`, and is therefore set to `2^n_features
#>   = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> 'C:\Users\jullum\AppData\Local\Temp\RtmpwByae7\shapr_obj_95203d935318.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#>     MSEv   Time   <NA>   <NA>   <NA>   <NA>
#> 1 745.21 784.91 165.13 222.71 226.42 183.39
