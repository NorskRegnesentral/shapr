...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:28 ───────────────────────────────
...
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736785d783422.rds'
#>
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:34 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367868b283c9.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:35 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782319f229.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:36 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367815f7523a.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:37 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367819d6b61c.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>                      MSEv Time
#> MC_empirical       188.54 6.63
#> sep_lm             715.79 0.71
#> sep_pcr            761.31 0.92
#> sep_splines        179.15 0.93
#> sep_recipe_example 680.72 1.43
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:39 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736783112be7d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:40 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736785d51dc83.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:18:41 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678404071b1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:19:02 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736784d6cf23.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:19:58 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678624f0345.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:20:01 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678420d09a5.rds'
#>
...
#> sep_tree_stump     196.95  0.81
#> sep_tree_default   190.77  0.79
#> sep_tree_cv        232.46 20.50
#> sep_tree_cv_2      241.85 56.64
#> sep_rf             218.68  2.53
#> sep_rf_cv          222.80 83.66
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:21:25 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736783f0a6e6c.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:21:27 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678f6f5bba.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:22:14 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367856cf1af5.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:23:04 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736787598b7de.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sep_rf             218.68  2.53
#> sep_rf_cv          222.80 83.66
#> sep_xgboost        256.64  2.08
#> sep_xgboost_cv     228.70 45.34
#> sep_xgboost_cv_par 228.70 48.89
```
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:23:05 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367820baf5de.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:23:06 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736781b1b14be.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:23:07 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367831e906f4.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:23:14 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782c39b0ea.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:23:16 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367812ab2a27.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:24:16 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782040a4a5.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> [1] "target is data.table, current is NULL"
```
...
#> sep_xgboost_cv_par 228.70 48.89
#> sur_lm             615.22  1.30
#> sur_xgboost        282.86  1.39
#> sur_xgboost_cv     232.34  6.98
#> sur_rf             176.26  1.87
#> sur_rf_cv          177.16 58.73
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:24:18 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736786f29a6a6.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:24:20 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782c797da8.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:01 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736785267fe1b.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:02 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736785f8a1df8.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sur_rf_cv          177.16 58.73
#> sep_ppr            316.06  1.71
#> sep_ppr_cv         274.25 40.48
#> sur_ppr            429.73  1.27
#> sur_ppr_cv         429.73  5.26
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:08 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367831ea670d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:10 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782588840f.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:12 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736785c7628fd.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:13 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736788b98203.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:25:17 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736781b213bed.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
print_MSEv_scores_and_time(explanation_list)
#>                      MSEv   Time
#> MC_independence    233.48   1.89
#> MC_empirical       188.54   6.63
#> MC_gaussian        214.11   1.29
#> MC_copula          214.78   1.27
#> MC_ctree           200.08   4.28
#> MC_vaeac           192.98 302.51
#> sep_lm             715.79   0.71
#> sep_pcr            761.31   0.92
#> sep_splines        179.15   0.93
#> sep_recipe_example 680.72   1.43
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:30:31 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367854a3f319.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:30:33 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736781d7787fd.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:30:38 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736787847e980.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:38:44 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736787fae608d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:38:45 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367870ea36c1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:38:48 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736785f0e1ba1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:38:50 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367852165ea9.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:40:33 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678507454b9.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:40:36 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782778158c.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:42:25 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678749169fc.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:42:28 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367865dd5ff7.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:43:44 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678b65e406.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:43:45 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678b62a6e1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:43:47 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782f35530d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:43:48 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367826871ff4.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:43:57 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367856b146a1.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:43:59 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678a283947.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:44:27 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736782bb0b222.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:44:29 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678769710d3.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>                   MSEv   Time
#> MC_independence 641.82   1.94
#> MC_ctree        555.58   4.60
#> MC_vaeac        623.53 484.98
#> sep_lm          550.06   1.19
#> sep_splines     541.36   2.67
#> sep_tree        753.84   2.30
#> sep_tree_cv     756.27 103.23
#> sep_rf          523.61   2.56
#> sep_rf_cv       596.04 108.95
#> sep_xgboost     760.08   2.76
#> sep_xgboost_cv  615.92  74.81
#> sur_lm          610.61   1.45
#> sur_splines     596.86   1.75
#> sur_tree        677.04   1.57
#> sur_tree_cv     789.37   8.62
#> sur_rf          406.06   2.01
#> sur_rf_cv       526.63  27.46
#> sur_xgboost     809.53   2.00
#> sur_xgboost_cv  518.44   8.10
...
from Python through the associated `pyshapr` Python library.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:44:43 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736784a5d895b.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:44:45 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_273678c6c579c.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:44:47 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_27367840591a00.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:44:49 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736784a0be9e9.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:45:21 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736787d568e5d.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#>
#> ── Starting `shapr::explain()` at 2026-09-11 13:45:58 ───────────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is therefore
#>   set to `2^n_features = 16`.
#>
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at: '/tmp/RtmpcavhZb/shapr_obj_2736781f6735a2.rds'
#>
#> ── Main computation started ──
#>
#> ℹ Using 16 of 16 coalitions.
...
#> sep_lm      715.79  1.65
#> sep_pcr     761.31  2.13
#> sep_splines 179.15  2.22
#> sep_tree_cv 232.46 32.27
#> sep_rf_cv   222.80 36.59
#> sur_rf_cv   177.16 28.64
