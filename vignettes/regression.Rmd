...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:48:55 ─────────────────
...
#> '/tmp/RtmpBnaTyV/shapr_obj_767debbb81e7.rds'
#> 
#> 
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:48:59 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de622e143d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:00 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de2fab29bc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:01 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de3d45de41.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de255ef0b8.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>                      MSEv  Time
#> MC_empirical       179.43  4.29
#> sep_lm             745.21  0.89
#> sep_pcr            784.91  0.81
#> sep_splines        165.13 -0.34
#> sep_recipe_example 687.45  1.00
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:02 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de23a78dc4.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de51e6cebc.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_splines        165.13 -0.34
#> sep_recipe_example 687.45  1.00
#> sep_tree_stump     218.05  0.73
#> sep_tree_default   177.68  0.87
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:04 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de62ff6c3e.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:13 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de64e2c26c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:31 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de709e4454.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:32 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de76b20436.rds'
#> 
...
#> sep_tree_stump     218.05  0.73
#> sep_tree_default   177.68  0.87
#> sep_tree_cv        222.71  9.19
#> sep_tree_cv_2      219.45 17.92
#> sep_rf             218.13  1.20
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:54 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de3234fe1d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:49:56 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de350314e5.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:25 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de1a79abf1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:32 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de4951f82.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_rf               218.13  1.20
#> sep_rf_cv            226.42 21.88
#> sep_xgboost          197.72  2.14
#> sep_xgboost_cv       168.45 27.61
#> sep_xgboost_cv_par   168.45  6.61
#> sep_xgboost_cv_2_par 155.02  5.82
```
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:38 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de4e260984.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:39 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de4a6ad2e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:40 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de7fb11618.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:44 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de2b4a50cc.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:50:45 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de51d0ac70.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:05 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de18fe2476.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> sep_xgboost_cv_2_par 155.02  5.82
#> sur_lm               649.61  0.60
#> sur_xgboost          169.92  1.17
#> sur_xgboost_cv       169.87  4.48
#> sur_rf               192.12  0.79
#> sur_rf_cv            183.39 19.85
#> sur_rf_cv_par        183.39 16.15
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:22 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de69bd9abe.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:23 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de3db84edb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:31 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de3d37d352.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:32 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de43746af.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sur_rf_cv_par        183.39 16.15
#> sep_ppr              327.23  0.81
#> sep_ppr_cv           246.28  7.80
#> sur_ppr              395.42  0.62
#> sur_ppr_cv           415.62  1.56
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:33 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de56a6bfeb.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:35 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de2140b214.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:36 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de62620890.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de2d22ae29.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:51:38 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767dec84c22e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
print_MSEv_scores_and_time(explanation_list)
#>                        MSEv  Time
#> MC_independence      206.92  1.37
#> MC_empirical         179.43  4.29
#> MC_gaussian          235.15  1.00
#> MC_copula            237.35  0.09
#> MC_ctree             190.82  1.89
#> MC_vaeac             145.06 87.86
#> sep_lm               745.21  0.89
#> sep_pcr              784.91  0.81
#> sep_splines          165.13 -0.34
#> sep_recipe_example   687.45  1.00
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:53:09 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de40627dc3.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:53:10 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de322395e5.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de7b49d388.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:55:46 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de4906ca7c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de5eda9e5b.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:55:47 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de415ca317.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:55:48 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de63e9dcf.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:56:05 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de6311e50a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:56:06 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de17ebbb75.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:56:35 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de58503e37.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:56:37 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de68d8d084.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:12 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767dea198298.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:13 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de44f28d9a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de5c19ac4c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de169e44c6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:15 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de757a9faf.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:16 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767dede307a3.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:25 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de22d41d0d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:26 ─────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
#> 
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de514d028f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#>                   MSEv   Time
#> MC_independence 641.82   1.11
#> MC_ctree        555.58   0.01
#> MC_vaeac        629.56 155.61
#> sep_lm          550.06   0.51
#> sep_splines     541.36   0.68
#> sep_tree        753.84   0.58
#> sep_tree_cv     756.27  17.16
#> sep_rf          523.61   0.94
#> sep_rf_cv       636.46  29.68
#> sep_xgboost     792.17   1.70
#> sep_xgboost_cv  595.64  34.68
#> sur_lm          610.61   0.40
#> sur_splines     596.86   0.47
#> sur_tree        677.04   0.46
#> sur_tree_cv     789.37   1.96
#> sur_rf          406.17   0.70
#> sur_rf_cv       521.25   9.21
#> sur_xgboost     742.54   0.62
#> sur_xgboost_cv  541.19   3.45
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:31 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de3389dc1c.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:32 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de5f96c7ad.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:33 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de19dcc6e6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:34 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de7c90a699.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:57:42 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de3e716608.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> ── Starting `shapr::explain()` at 2025-08-21 09:58:04 ─────────────────
#> ℹ Feature classes extracted from the model contain `NA`.
#>   Assuming feature classes from the data are correct.ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and
#>   is therefore set to `2^n_features = 16`.
#> ── Explanation overview ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/RtmpBnaTyV/shapr_obj_767de5b3969fd.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_tree_cv 222.71  8.73
#> sep_rf_cv   226.42 21.81
#> sur_rf_cv   183.39 19.40
