...
[`tidymodels`](https://tidymodels.org/) framework is a
...
Furthermore, click [here](https://tidymodels.org/find/parsnip/)
...
"decision tree" in the [list of tidymodels](https://tidymodels.org/find/parsnip/),
...
[models](https://tidymodels.org/find/parsnip/), we might
...
The following is based on the [`tidymodels` guide](https://tidymodels.org/learn/develop/models/)
