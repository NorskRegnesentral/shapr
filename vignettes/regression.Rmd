...
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2346dd5433.rds'
#> 
#> 
#> 
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231e6f4bdc.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be235b84e910.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23425d8363.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23570b66c0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#>                      MSEv Time
#> MC_empirical       179.43 6.63
#> sep_lm             745.21 0.73
#> sep_pcr            784.91 0.92
#> sep_splines        165.13 1.04
#> sep_recipe_example 687.45 1.26
```
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23e91b6c0.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2313a4507e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_splines        165.13 1.04
#> sep_recipe_example 687.45 1.26
#> sep_tree_stump     218.05 0.87
#> sep_tree_default   177.68 0.92
```
...
#> Error in data.table(tree_depth = c(1, 5, 10, 15)): could not find function "data.table"
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233903663b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2349f4d3df.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2310d22812.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232b6ba23.rds'
#> 
#> ── Additional details about the regression model 
#> Random Forest Model Specification
#> (regression)
#> 
#> Main Arguments: mtry = hardhat::tune()
#> trees = hardhat::tune()
#> 
...
#> #1: mtry = 1 trees = 750 rmse = 28.62
#> rmse_std_err = 2.58
#> #2: mtry = 1 trees = 400 rmse = 28.82
#> rmse_std_err = 2.45
#> #3: mtry = 1 trees = 50 rmse = 28.91
#> rmse_std_err = 2.48
#> #4: mtry = 2 trees = 50 rmse = 29.08
#> rmse_std_err = 2.22
#> #5: mtry = 2 trees = 400 rmse = 29.27
#> rmse_std_err = 2.28
#> #6: mtry = 2 trees = 750 rmse = 29.43
#> rmse_std_err = 2.28
#> 
#> ── Top 6 best configs for  v(2 4) (using 5-fold CV) 
#> #1: mtry = 2 trees = 50 rmse = 21.10
#> rmse_std_err = 0.89
#> #2: mtry = 1 trees = 750 rmse = 21.29
#> rmse_std_err = 0.67
#> #3: mtry = 2 trees = 400 rmse = 21.31
#> rmse_std_err = 1.00
#> #4: mtry = 1 trees = 400 rmse = 21.38
#> rmse_std_err = 0.73
#> #5: mtry = 2 trees = 750 rmse = 21.38
#> rmse_std_err = 1.02
#> #6: mtry = 1 trees = 50 rmse = 21.47
#> rmse_std_err = 0.69
#> 
#> ── Top 6 best configs for  v(1 3) (using 5-fold CV) 
#> #1: mtry = 2 trees = 50 rmse = 21.56
#> rmse_std_err = 3.01
#> #2: mtry = 1 trees = 750 rmse = 21.71
#> rmse_std_err = 3.11
#> #3: mtry = 1 trees = 400 rmse = 21.73
#> rmse_std_err = 3.17
#> #4: mtry = 1 trees = 50 rmse = 21.83
#> rmse_std_err = 3.12
#> #5: mtry = 2 trees = 750 rmse = 21.87
#> rmse_std_err = 2.92
#> #6: mtry = 2 trees = 400 rmse = 21.92
#> rmse_std_err = 3.03
#> 
#> ── Top 6 best configs for  v(3 4) (using 5-fold CV) 
#> #1: mtry = 1 trees = 50 rmse = 22.21
#> rmse_std_err = 4.17
#> #2: mtry = 1 trees = 400 rmse = 22.35
#> rmse_std_err = 4.24
#> #3: mtry = 1 trees = 750 rmse = 22.37
#> rmse_std_err = 4.26
#> #4: mtry = 2 trees = 400 rmse = 23.45
#> rmse_std_err = 4.10
#> #5: mtry = 2 trees = 750 rmse = 23.60
#> rmse_std_err = 4.09
#> #6: mtry = 2 trees = 50 rmse = 24.35
#> rmse_std_err = 4.00
#> 
#> ── Top 6 best configs for  v(2 3) (using 5-fold CV) 
#> #1: mtry = 1 trees = 50 rmse = 17.53
#> rmse_std_err = 2.14
#> #2: mtry = 2 trees = 750 rmse = 17.55
#> rmse_std_err = 2.41
#> #3: mtry = 1 trees = 400 rmse = 17.64
#> rmse_std_err = 2.01
#> #4: mtry = 2 trees = 50 rmse = 17.69
#> rmse_std_err = 2.46
#> #5: mtry = 1 trees = 750 rmse = 17.81
#> rmse_std_err = 2.07
#> #6: mtry = 2 trees = 400 rmse = 17.94
#> rmse_std_err = 2.51
#> 
#> ── Top 3 best configs for  v(3) (using 5-fold CV) 
#> #1: mtry = 1 trees = 50 rmse = 22.44
#> rmse_std_err = 4.63
#> #2: mtry = 1 trees = 400 rmse = 22.59
#> rmse_std_err = 4.63
#> #3: mtry = 1 trees = 750 rmse = 22.64
#> rmse_std_err = 4.62
#> 
#> ── Top 6 best configs for  v(1 2) (using 5-fold CV) 
#> #1: mtry = 1 trees = 400 rmse = 22.10
#> rmse_std_err = 2.51
#> #2: mtry = 1 trees = 750 rmse = 22.40
#> rmse_std_err = 2.65
#> #3: mtry = 1 trees = 50 rmse = 22.69
#> rmse_std_err = 2.47
#> #4: mtry = 2 trees = 50 rmse = 23.01
#> rmse_std_err = 2.24
#> #5: mtry = 2 trees = 400 rmse = 23.16
#> rmse_std_err = 2.48
#> #6: mtry = 2 trees = 750 rmse = 23.18
#> rmse_std_err = 2.49
#> 
#> ── Top 3 best configs for  v(4) (using 5-fold CV) 
#> #1: mtry = 1 trees = 400 rmse = 32.06
#> rmse_std_err = 4.28
#> #2: mtry = 1 trees = 750 rmse = 32.13
#> rmse_std_err = 4.26
#> #3: mtry = 1 trees = 50 rmse = 32.26
#> rmse_std_err = 4.35
#> 
#> ── Top 3 best configs for  v(1) (using 5-fold CV) 
#> #1: mtry = 1 trees = 400 rmse = 30.33
#> rmse_std_err = 3.37
#> #2: mtry = 1 trees = 750 rmse = 30.50
#> rmse_std_err = 3.42
#> #3: mtry = 1 trees = 50 rmse = 30.61
#> rmse_std_err = 3.51
#> 
#> ── Top 3 best configs for  v(2) (using 5-fold CV) 
#> #1: mtry = 1 trees = 750 rmse = 26.64
#> rmse_std_err = 2.31
#> #2: mtry = 1 trees = 400 rmse = 26.84
#> rmse_std_err = 2.27
#> #3: mtry = 1 trees = 50 rmse = 26.96
#> rmse_std_err = 2.17
#> 
#> ── Top 9 best configs for  v(1 2 4) (using 5-fold CV) 
#> #1: mtry = 2 trees = 750 rmse = 20.32
#> rmse_std_err = 2.47
#> #2: mtry = 2 trees = 400 rmse = 20.45
#> rmse_std_err = 2.50
#> #3: mtry = 1 trees = 750 rmse = 20.45
#> rmse_std_err = 2.91
#> #4: mtry = 2 trees = 50 rmse = 20.46
#> rmse_std_err = 2.54
#> #5: mtry = 1 trees = 400 rmse = 20.53
#> rmse_std_err = 2.98
#> #6: mtry = 3 trees = 50 rmse = 20.72
#> rmse_std_err = 2.38
#> #7: mtry = 1 trees = 50 rmse = 20.78
#> rmse_std_err = 2.70
#> #8: mtry = 3 trees = 400 rmse = 20.93
#> rmse_std_err = 2.42
#> #9: mtry = 3 trees = 750 rmse = 21.08
#> rmse_std_err = 2.48
#> 
#> ── Top 9 best configs for  v(1 2 3) (using 5-fold CV) 
#> #1: mtry = 2 trees = 400 rmse = 16.31
#> rmse_std_err = 2.77
#> #2: mtry = 2 trees = 750 rmse = 16.36
#> rmse_std_err = 2.71
#> #3: mtry = 3 trees = 400 rmse = 16.40
#> rmse_std_err = 2.83
#> #4: mtry = 3 trees = 750 rmse = 16.42
#> rmse_std_err = 2.86
#> #5: mtry = 1 trees = 400 rmse = 16.80
#> rmse_std_err = 3.06
#> #6: mtry = 1 trees = 750 rmse = 16.94
#> rmse_std_err = 3.10
#> #7: mtry = 2 trees = 50 rmse = 17.02
#> rmse_std_err = 2.96
#> #8: mtry = 1 trees = 50 rmse = 17.04
#> rmse_std_err = 3.26
#> #9: mtry = 3 trees = 50 rmse = 17.24
#> rmse_std_err = 2.96
#> 
#> ── Top 9 best configs for  v(1 3 4) (using 5-fold CV) 
#> #1: mtry = 1 trees = 50 rmse = 21.49
#> rmse_std_err = 4.36
#> #2: mtry = 1 trees = 750 rmse = 21.83
#> rmse_std_err = 4.39
#> #3: mtry = 1 trees = 400 rmse = 21.96
#> rmse_std_err = 4.24
#> #4: mtry = 2 trees = 400 rmse = 22.63
#> rmse_std_err = 4.16
#> #5: mtry = 2 trees = 50 rmse = 22.64
#> rmse_std_err = 4.55
#> #6: mtry = 2 trees = 750 rmse = 22.93
#> rmse_std_err = 4.06
#> #7: mtry = 3 trees = 400 rmse = 23.37
#> rmse_std_err = 3.86
#> #8: mtry = 3 trees = 50 rmse = 23.44
#> rmse_std_err = 3.94
#> #9: mtry = 3 trees = 750 rmse = 23.46
#> rmse_std_err = 3.86
#> 
#> ── Top 9 best configs for  v(2 3 4) (using 5-fold CV) 
#> #1: mtry = 3 trees = 400 rmse = 17.79
#> rmse_std_err = 3.45
#> #2: mtry = 2 trees = 50 rmse = 17.83
#> rmse_std_err = 3.51
#> #3: mtry = 3 trees = 750 rmse = 17.87
#> rmse_std_err = 3.42
#> #4: mtry = 1 trees = 50 rmse = 17.87
#> rmse_std_err = 3.49
#> #5: mtry = 2 trees = 400 rmse = 17.87
#> rmse_std_err = 3.54
#> #6: mtry = 3 trees = 50 rmse = 17.89
#> rmse_std_err = 3.28
#> #7: mtry = 2 trees = 750 rmse = 17.93
#> rmse_std_err = 3.54
#> #8: mtry = 1 trees = 400 rmse = 18.04
#> rmse_std_err = 3.62
#> #9: mtry = 1 trees = 750 rmse = 18.09
#> rmse_std_err = 3.61
```
...
#> sep_tree_stump     218.05  0.87
#> sep_tree_default   177.68  0.92
#> sep_tree_cv        222.71 15.74
#> sep_tree_cv_2      219.45 30.17
#> sep_rf             218.13  1.29
#> sep_rf_cv          217.21 33.40
```
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237df3b04b.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236841eace.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233a77ebb2.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23ea36303.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_rf               218.13  1.29
#> sep_rf_cv            217.21 33.40
#> sep_xgboost          197.72  2.24
#> sep_xgboost_cv       168.45 43.83
#> sep_xgboost_cv_par   168.45 15.13
#> sep_xgboost_cv_2_par 155.02 19.75
```
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233fe7dfd.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23452f0ec1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2360f1a015.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23462f9fb1.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234c8aa7d2.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23236de5f9.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> sep_xgboost_cv_2_par 155.02 19.75
#> sur_lm               649.61  0.67
#> sur_xgboost          169.92  1.16
#> sur_xgboost_cv       169.87  6.35
#> sur_rf               192.12  0.78
#> sur_rf_cv            177.48 24.25
#> sur_rf_cv_par        177.48 13.80
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be235f7f06d.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2359a73857.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23421912e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23406fdc20.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sur_rf_cv_par        177.48 13.80
#> sep_ppr              327.23  0.88
#> sep_ppr_cv           246.28 13.48
#> sur_ppr              395.42  0.67
#> sur_ppr_cv           415.62  2.08
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232a218ea1.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231aba3539.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234e1b79cb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234c694223.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232f5e5b4f.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
print_MSEv_scores_and_time(explanation_list)
#>                        MSEv   Time
#> MC_independence      206.92   1.16
#> MC_empirical         179.43   6.63
#> MC_gaussian          235.15   0.84
#> MC_copula            237.35   0.85
#> MC_ctree             190.82   1.95
#> MC_vaeac             145.06 104.67
#> sep_lm               745.21   0.73
#> sep_pcr              784.91   0.92
#> sep_splines          165.13   1.04
#> sep_recipe_example   687.45   1.26
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23199cb63f.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be235260a416.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be232f93fc9a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2373645a1a.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be233d4aac4c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231306702.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237785eb49.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be237dba886c.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2376959a07.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23130416e6.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234dad909d.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236867c5d6.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be235f288edb.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2398ee7aa.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2317c62125.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23314286a4.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be231b27388e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2328161c8a.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23498c1e1e.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#>                   MSEv   Time
#> MC_independence 641.82   0.56
#> MC_ctree        555.58   1.37
#> MC_vaeac        623.53 171.78
#> sep_lm          550.06   0.66
#> sep_splines     541.36   0.83
#> sep_tree        753.84   0.76
#> sep_tree_cv     756.27  34.82
#> sep_rf          523.61   1.09
#> sep_rf_cv       597.56  45.10
#> sep_xgboost     792.17   1.80
#> sep_xgboost_cv  595.64  64.94
#> sur_lm          610.61   0.42
#> sur_splines     596.86   0.50
#> sur_tree        677.04   0.46
#> sur_tree_cv     789.37   2.63
#> sur_rf          406.17   0.72
#> sur_rf_cv       528.15  12.30
#> sur_xgboost     742.54   0.80
#> sur_xgboost_cv  541.19   6.11
...
#> 
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2331efd3ac.rds'
#> 
#> 
#> 
#> ── Main computation started ──
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be23c4e41f4.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236cc5d177.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be2325542dc7.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be234998ee40.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> • Number of observations to explain: 20
#> • Computations (temporary) saved at:
#> '/tmp/Rtmpj2jePl/shapr_obj_4be236df63879.rds'
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions.
...
#> sep_tree_cv 222.71 16.44
#> sep_rf_cv   217.21 33.09
#> sur_rf_cv   177.48 21.89
