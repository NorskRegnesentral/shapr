# shapr ![](reference/figures/nrlogo_new.jpg)
...
functions $`v(S)`$, with different trade-offs in runtime, memory use,
...
notably, we moved from using two functions
([`shapr()`](https://norskregnesentral.github.io/shapr/reference/shapr-package.md)
and
[`explain()`](https://norskregnesentral.github.io/shapr/reference/explain.md))
to one function
([`explain()`](https://norskregnesentral.github.io/shapr/reference/explain.md)).
In addition, custom models are now explained by passing the prediction
...
computed by setting `scope = "global"` in
[`explain()`](https://norskregnesentral.github.io/shapr/reference/explain.md).
...
![](reference/figures/README-sage_example-1.png)
...
([2024](#ref-olsen2024comparative)) and Olsen and Jullum
([2025](#ref-olsen2025improving)). See also Sellereite and Jullum
