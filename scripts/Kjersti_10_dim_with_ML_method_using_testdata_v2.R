...
DT.merged[,.(error.ML=mean(abserror.ML)),by="wcomb"]
DT.merged[,.(error.ML=mean(abserror.ML),error.emp=mean(abserror.emp),error.nnet=mean(abserror.nnet),error.indep=mean(abserror.indep)),by="nfeatures"]
...
# 1:         0  0.00000 0.000000000000000000000    0.00000 0.000000000000000000000
# 2:         1  0.01975 0.018692276918115393464    0.01607 0.036733297957574254089
# 3:         2  0.01344 0.026683861988069886018    0.02414 0.053323622866062833636
# 4:         3  0.02198 0.028536319767528999652    0.03088 0.063860661442319444081
# 5:         4  0.01935 0.028519733445701873215    0.03753 0.069625890085019848108
# 6:         5  0.02706 0.029097899432039414647    0.04147 0.070539602920329735891
# 7:         6  0.03354 0.029900346288790895233    0.04591 0.066895082811917042087
# 8:         7  0.03805 0.029112869126525234287    0.04765 0.058598016766223719187
# 9:         8  0.04086 0.025137579489724802551    0.04962 0.045366084013279288356
# 10:         9  0.03636 0.016277163193559686383    0.05274 0.026603483830742648969
# 11:        10  0.00000 0.000000000000000002836    0.00000 0.000000000000000001999
> DT.merged[,mean(abserror.ML),by="nfeatures"]
nfeatures         V1
1:         0 0.00000000
2:         1 0.03735170
