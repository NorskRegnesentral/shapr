...
#' This is the same for all prediction and set by the user through the argument \code{prediction_zero}.
...
#' such as the mean of the predictions in the training data, is also possible.
#'
#' @export
#'
