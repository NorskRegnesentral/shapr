...
explain.empirical <- function(x, explainer, approach, prediction_zero,
  ...
  explainer$x_test <- as.matrix(preprocess_data(x, explainer$feature_list, "model", "test data"))
...
explain.ctree <- function(x, explainer, approach, prediction_zero,
  ...
  # Add arguments to explainer object
  explainer$x_test <- preprocess_data(x, explainer$feature_list, "model", "test data")
  explainer$approach <- approach
