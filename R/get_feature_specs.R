...
get_feature_specs <- function(get_model_specs, model) {
  # Check that get_model_specs is a proper function (R + py)
  # Extract natively supported functions for get_model_specs if they exist and not passed (R only)
  # Apply get_model_specs to model and check that it provides the right output format (R and py)
