...
class TestCategoricalOutputs:
    ...
    def test_rf_regressor_ctree_categorical_basic(
        self,
        california_housing_categorical_data,
    ...
    @pytest.mark.snapshot
    def test_rf_regressor_ctree_categorical_with_groups(
        self,
        california_housing_categorical_data,
        trained_rf_regressor_categorical,
    ...
    @pytest.mark.snapshot
    def test_rf_regressor_arf_categorical_basic(
        self,
        california_housing_categorical_data,
        trained_rf_regressor_categorical,
        extract_shapley_outputs,
    ...
    @pytest.mark.localonly
    @pytest.mark.snapshot
    def test_rf_regressor_vaeac_categorical_basic(
        self,
        california_housing_categorical_data,
        trained_rf_regressor_categorical,
        extract_shapley_outputs,
    ...
    @pytest.mark.localonly
    @pytest.mark.snapshot
    def test_rf_regressor_vaeac_categorical_with_groups(
        self,
        california_housing_categorical_data,
        trained_rf_regressor_categorical,
        categorical_group_config,
