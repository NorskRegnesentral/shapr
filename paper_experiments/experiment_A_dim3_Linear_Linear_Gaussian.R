...
joint_csv_filename <- "all_results_experiment_A_dim3_Linear_Linear_Gaussian.csv" # Set to NULL if results should not be included in any joint results table

initial_current_csv_filename <- "experiment_A_dim3_Linear_Linear_Gaussian"
true_model <- "Linear"
fitted_model <- "Linear"
variables <- "Gaussian"
