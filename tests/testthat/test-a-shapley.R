...
#   globalfun_1 <- list(model_type.gbm = function(x) "regression")
#   attach(globalfun_1)
...
#   # Simulate adding to .GlobalEnv
#   globalfun_2 <- list(predict_model.gbm = function(x, newdata) {
...
#
#   # Simulate adding to .GlobalEnv
#   globalfun_3 <- list(get_model_specs.gbm = function(x, feature_labels = NULL) {
#
#     feature_list = list()
