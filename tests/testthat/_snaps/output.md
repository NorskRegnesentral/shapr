...
# output_lingaus_full_also_with_precomputed

    Code
      (out <- code)
    Output
          none Solar.R    Wind     Temp   Month     Day
      1: 42.26  -8.541   7.881  14.5116  0.6612 -1.7304
      2: 42.26   4.854  -4.775 -11.5989 -1.0062 -1.1725
      3: 42.26   7.442 -25.551   0.3714 -0.4358  0.7852
...
# output_lingaus_10_perms_also_with_precomputed

    Code
      (out <- code)
    Output
          none Solar.R    Wind    Temp   Month     Day
      1: 42.26  -8.626   8.882  13.641  0.5899 -1.7057
      2: 42.26   4.856  -3.918 -12.277 -1.1943 -1.1651
      3: 42.26   7.413 -25.266   0.297 -0.6021  0.7707
