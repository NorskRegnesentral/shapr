# output_sage_independence_lm
    ...
    Output
      ...
      1:         NA -1119   55.44 240.1 426.5 -23.91 -0.7152
...
# output_sage_gaussian_xgboost
    ...
    Output
         explain_id  none Solar.R  Wind  Temp Month   Day
             <lgcl> <num>   <num> <num> <num> <num> <num>
      1:         NA -1119   148.1 440.6 515.3 1.215 9.927
...
# output_sage_empirical_lm
    ...
    Output
         explain_id  none Solar.R  Wind  Temp Month   Day
             <lgcl> <num>   <num> <num> <num> <num> <num>
      1:         NA -1119   123.1 123.1 263.6 90.75 96.98
...
# output_sage_copula_lm_iter
    ...
    Output
         explain_id  none Solar.R  Wind  Temp Month   Day
             <lgcl> <num>   <num> <num> <num> <num> <num>
      1:         NA -1119   64.84 257.2 362.6 10.57 2.339
...
# output_sage_loss_mae
    ...
    Output
         explain_id   none Solar.R  Wind  Temp  Month     Day
             <lgcl>  <num>   <num> <num> <num>  <num>   <num>
      1:         NA -26.87  0.9472 3.318 7.258 0.2682 0.05485
...
# output_sage_loss_mape
    ...
    Output
         explain_id   none Solar.R  Wind  Temp Month     Day
             <lgcl>  <num>   <num> <num> <num> <num>   <num>
      1:         NA -153.4   19.29 11.15 53.72 2.367 -0.9627
...
# output_sage_binary
    ...
    Output
         explain_id  none Solar.R   Wind  Temp   Month    Day
             <lgcl> <num>   <num>  <num> <num>   <num>  <num>
      1:         NA -2881  -2.249 -4.756 -14.9 -0.9106 -1.964
