...
# data_complete <- data_complete[sample(1:.N)]
#
# y_var_numeric <- "Ozone"
#
...
#
# test_that("data specification", {
#   expect_snapshot_output(explain(x_train_mixed, x_test_mixed, model_lm_numeric, approach = "independence", prediction_zero = p0))
#
# })
#
