...
#> 
#> ── Starting `shapr::explain()` at 2026-09-11 13:14:15 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_646245e3fd9a.rds
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-09-11 13:14:16 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_64622844e035.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_646278c2ddc3.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_646239cfe8a5.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
#> ℹ Coalitions split into 10 batches (mean 1.6 per batch). 
#> 
#> ── Starting `shapr::explain()` at 2026-09-11 13:14:18 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_646253602ce7.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
