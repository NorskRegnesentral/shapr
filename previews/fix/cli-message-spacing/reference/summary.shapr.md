...
#> 
#> ── Starting `shapr::explain()` at 2026-09-11 13:14:28 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_646236c2c0f.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-09-11 13:14:28
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
