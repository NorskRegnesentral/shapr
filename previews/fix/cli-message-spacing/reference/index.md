...
- [`explain()`](https://norskregnesentral.github.io/shapr/reference/explain.md)
  : Explain the Output of Machine Learning Models with Dependence-Aware
...
- [`explain_forecast()`](https://norskregnesentral.github.io/shapr/reference/explain_forecast.md)
  : Explain a Forecast from Time Series Models with Dependence-Aware
  (Conditional/Observational) Shapley Values
...
- [`get_supported_approaches()`](https://norskregnesentral.github.io/shapr/reference/get_supported_approaches.md)
