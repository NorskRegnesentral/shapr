...
#> 
#> ── Starting `shapr::explain()` at 2026-09-11 13:13:59 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_646241e5b6e6.rds
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-09-11 13:14:08 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 50
#> • Computations (temporary) saved at: /tmp/RtmpfHEjav/shapr_obj_6462734aaa2.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
