...
- We recommend that you create a Git branch for each pull request
  (PR).  
- Look at the CircleCI build status before and after making changes. The
...
Please note that the shapr project is released with a [Contributor Code
of
Conduct](https://norskregnesentral.github.io/shapr/CODE_OF_CONDUCT.md).
