...
#> 
#> ── Starting `shapr::explain()` at 2026-08-20 07:37:45 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpdrGKgt/shapr_obj_1b9841d7e884.rds
#> 
...
#> 
#> ── Starting `shapr::explain()` at 2026-08-20 07:37:46 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpdrGKgt/shapr_obj_1b981749be24.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpdrGKgt/shapr_obj_1b9878dcd298.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
#> ℹ Coalitions split into 10 batches (mean 1.6 per batch). 
#> 
#> ── Starting `shapr::explain()` at 2026-08-20 07:37:47 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpdrGKgt/shapr_obj_1b986d2dcc52.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
#> ℹ Coalitions split into 10 batches (mean 1.6 per batch). 
#> 
#> ── Starting `shapr::explain()` at 2026-08-20 07:37:48 ──────────────────────────
#> ℹ `max_n_coalitions` is `NULL` or larger than `2^n_features = 16`, and is
#>   therefore set to `2^n_features = 16`.
#> 
#> ── Explanation overview ──
...
#> • Number of feature-wise Shapley values: 4
#> • Number of observations to explain: 25
#> • Computations (temporary) saved at: /tmp/RtmpdrGKgt/shapr_obj_1b984ecb2a19.rds
#> 
#> ── Main computation started ──
#> 
#> ℹ Using 16 of 16 coalitions. 
