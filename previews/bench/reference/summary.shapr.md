...
#> 
#> ── Starting `shapr::explain()` at 2026-08-20 07:38:33 ──────────────────────────
...
#> • Computations (temporary) saved at: /tmp/RtmpdrGKgt/shapr_obj_1b98148ed83e.rds
#> 
...
#> • Computed with `shapr::explain()` in 0.4 seconds, started 2026-08-20 07:38:33
#> • Model class: <lm>
#> • v(S) estimation class: Monte Carlo integration
#> • Approach: gaussian
#> • Procedure: Non-iterative
